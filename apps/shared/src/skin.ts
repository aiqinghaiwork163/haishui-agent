/**
 * Canonical Haishui skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$HAISHUI_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`haishui_cli/skin_engine.py`),
 ...
 *   • CLI     → `haishui_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
