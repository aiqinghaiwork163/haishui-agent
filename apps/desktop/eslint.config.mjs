...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @haishui/plugin-sdk (+ react), never `@/…`
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@haishui/shared'],
              message: 'Plugins import only @haishui/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
