...
export const en: Translations = {
  connectors: {
    ...
    disclaimer: 'Connecting is optional. Only authorize the apps you want Haishui to use.',
    execution: 'Connector tools'
  },

  sessionImport: {
    title: 'Continue from another app',
    subtitle: 'Bring a conversation into Haishui and pick up where you left off.',
    ...
    chooseHelp: 'Choose a session to read its history before bringing it into Haishui.',
    ...
    you: 'You',
    snapshot: 'This conversation is already in Haishui. Open your existing copy to continue.',
    copyNotice:
      'Copies conversation text. Source files stay unchanged. Tool output and reasoning are not carried over.',
    importing: 'Importing…',
    open: 'Open in Haishui',
    continue: 'Continue in Haishui',
  ...
  boot: {
    ready: 'Haishui Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Haishui settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Haishui backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingHaishuiDesktop: 'Starting Haishui Desktop…'
    },
    errors: {
      ...
      backgroundExitedDuringStartup: 'Haishui stopped right after it started.',
      backendStopped: 'Haishui stopped working in the background',
      restartHaishui: 'Restart Haishui',
      openLogs: 'Open logs',
      desktopBootFailed: "Haishui couldn't start",
      gatewayConnectionLost: 'Haishui lost its connection',
      ...
      gatewaySignInRequired: 'Your remote Haishui signed you out',
      gatewaySignInRequiredDetail: 'Sign in again to reconnect. Your chats and settings are safe.',
      signInAgain: 'Sign in again',
      ipcBridgeUnavailable: "Haishui Desktop couldn't talk to its own background layer. Restart the app."
    },
    // Plain causes for a local backend boot failure (`classifyBootFailure`);
    // the raw output stays behind "Show recent logs".
    causes: {
      exitedEarly: "Haishui' background service stopped right after starting.",
      timedOut: "Haishui' background service didn't answer in time.",
      permission: "Haishui couldn't write to its data folder (permission problem).",
      diskFull: 'The disk is full, so Haishui could not start.',
      portInUse: 'Another program is using the network port Haishui needs.',
      installMissing: "Part of Haishui' installation is missing. Choose Repair install to put it back."
    },
    failure: {
      title: "Haishui couldn't start",
      description:
        "Haishui' background service didn't come up. Try one of the recovery steps below. Nothing here deletes your chats or settings.",
      details: 'Details',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Haishui backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHaishui: 'Update Haishui',
    ...
    errors: {
      ...
      storageFailure: "Haishui couldn't save to its data folder. Open Maintenance to check and repair it.",
      gatewayAuthFailed:
        'This Haishui no longer accepts your saved sign-in. Open Gateways and sign in again (or paste a new access token), then retry.',
      methodNotAllowed: "Haishui' background service is out of step with the app, probably after an update. Restart it to fix this.",
      ...
      codeSkewRestartRequired: 'Haishui was updated but is still running the old version. Restart it to finish the update.',
      restartHaishuiFailed: "Couldn't restart Haishui"
    },
    actions: {
      restartHaishui: 'Restart Haishui',
      openKeys: 'Open Keys',
    ...
    voice: {
      ...
      liveDelegationFailed: 'Could not hand the request to Haishui',
    ...
    native: {
      ...
      inputBody: 'Haishui is waiting for your response.',
      turnDoneTitle: 'Haishui finished',
      turnDoneBody: '',
  ...
  sendDiagnostics: {
    ...
    failedHint:
      'You can also run `haishui debug share --nous` from a terminal, or `haishui debug share --local` to print the report without uploading.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Haishui defaults?',
    ...
    plugins: {
      ...
      installModal: {
        ...
        catalogPinned: (name, sha) =>
          `Haishui catalog entry "${name}" — the agent component installs at the reviewed pin${sha ? ` ${sha}` : ''}, not the branch tip.`,
    ...
    vault: {
      ...
      otpHint: 'The "setup key" the site shows when you enable 2FA. With it saved, Haishui generates the codes itself.',
      ...
      sources: {
        ...
        notInstalled: name =>
          `Not detected. Install the ${name} command-line tool and sign in to it; Haishui picks it up automatically.`,
        disabledDesc: 'Detected but turned off for Haishui.',
        lockedDesc: 'Detected. The agent will ask you to unlock it when it needs a login, or unlock now.',
        unlockedDesc: 'Unlocked for this session. Locks automatically after 30 minutes idle or when Haishui closes.',
        statusLocked: 'Locked',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Haishui is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Haishui asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Haishui was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Haishui was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Haishui follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Haishui can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'Occasional hints from the app and Haishui. Each tip appears once. Turns off automatically after your first 30 days; you can turn it back on.',
      tipsReset: (count: number) => `Show ${count} ${count === 1 ? 'tip' : 'tips'} again`,
      toursTitle: 'Guided Tours',
      toursDesc:
        'Let Haishui spotlight each step as it guides you through the app. Turns off automatically after your first 30 days; you can turn it back on.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Haishui is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Haishui, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    uninstallSection: {
      ...
      uninstallHaishui: 'Uninstall Haishui'
    },
    poolLimits: {
    ...
    about: {
      heading: 'Haishui Desktop',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The Haishui runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      bundleOutOfSyncAction: 'Get the installer',
      bundleSwapPending: 'Restart to finish the update',
      bundleSwapPendingDesc:
        'The updated app is already installed — Haishui only needs to restart to load it. Chats and settings are untouched.',
      bundleSwapPendingAction: 'Restart Haishui',
      updates: 'Updates',
      checkNow: 'Check now',
      checking: 'Checking…',
      seeWhatsNew: "See what's new",
      ...
      automaticUpdatesDesc:
        'Haishui checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Haishui configuration...',
    ...
    screenshot: {
      ...
      enabledDesc:
        'Press both Command keys together from any app to capture its frontmost window and attach it to your current Haishui draft. Never sends automatically. Off by default; applies only to this Mac. Window contents may be sensitive — review the attachment before sending.',
      ...
      inputPermission:
        'Input Monitoring permission lets Haishui detect both Command keys while another app is active. Allow Haishui in System Settings → Privacy & Security → Input Monitoring, then return here and retry.',
      screenPermission:
        'Screen Recording permission lets Haishui capture the frontmost app window when you use this shortcut. Allow Haishui in System Settings → Privacy & Security → Screen Recording, then return here and retry. Restart Haishui if macOS asks.',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Haishui.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Haishui gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Haishui Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Haishui Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Haishui runtime managed by this app.',
      kindRemoteDesc: 'A Haishui gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Haishui Cloud account.',
      kindSshDesc: 'A Haishui install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Haishui manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Haishui Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      unavailableDesc: 'Connection settings can only be changed from the Haishui Desktop app on the computer running it.',
      title: 'Gateway Connection',
      envOverride: 'env override',
      intro:
        'Local by default. Use remote when this app should drive a Haishui backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'This connection was fixed by the way Haishui was launched.',
      envOverrideDesc:
        'A startup setting outside the app chose this connection, so the options below are read-only. Restart Haishui without that setting — or ask whoever set it up — to change it here.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Haishui backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Haishui backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Haishui Cloud',
      cloudDesc: 'Sign in once to Haishui Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Haishui Cloud',
      cloudSignIn: 'Sign in to Haishui Cloud',
      cloudSignedIn: 'Signed in to Haishui Cloud',
      cloudNeedsSignIn: 'Sign in to Haishui Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Haishui Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Haishui Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Haishui Cloud',
      cloudSignedOutMessage: 'Cleared the Haishui Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /haishui.',
      probing: 'Checking how this gateway authenticates…',
      probeError: "Haishui can't reach that address. Check the URL and that the other computer is running Haishui — sign-in options appear once it answers.",
      signedIn: 'Signed in',
      signIn: 'Sign in',
      signOut: 'Sign out',
      ...
      restartingMessage: 'Haishui Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Haishui ${version}` : ''}`,
      ...
      sshDesc:
        'Haishui is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHaishuiPathTitle: 'Haishui path (optional)',
      sshHaishuiPathDesc: 'Full path to the remote haishui binary. Blank = auto-detect.',
      sshHaishuiPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Haishui found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Haishui runs ssh non-interactively.',
      sshErrHostKey:
      ...
      sshErrUpdateRequired: 'Update Haishui on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Haishui. Review the exact configuration below — it comes from the link, not from Haishui.',
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, ${backend} backend. Haishui starts and manages the server for you.`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Haishui runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Haishui at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      terminalBackend: {
        ...
        unavailableMessage: backend =>
          `Haishui can't run shell commands right now: ${backend} isn't ready. Switch to Local, or finish setting up ${backend} and try again.`,
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: 'Let Haishui browse with a snapshot of your default browser profile, so sites open already signed in.',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via haishui curator restore.',
    tabPlugins: 'Plugins',
    plugins: {
      ...
      defaultProfile: 'Haishui (default)',
      kindAgent: 'Agent',
      kindDesktop: 'Desktop',
      ...
      legacyBackend: 'This backend predates key-addressed plugin toggles — update Haishui to manage it here.',
      ...
      catalogProvenance: (sha: string) => `Installed from the Haishui catalog${sha ? ` at pin ${sha}` : ''}.`,
  ...
  starmap: {
    ...
    emptyDesc: 'As Haishui builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Haishui to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Haishui to generate pets.',
      backgroundHint: 'You can close this — Haishui will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Haishui desktop' },
    ...
    haishuiActiveSessions: (version, count) => `Haishui ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    restartFailedManual: "Haishui couldn't restart to apply your messaging settings",
    ...
    telegramQr: {
      ...
      subtitle: 'Both options connect a bot you control and save its credentials only to this Haishui installation.',
      quickSetup: 'Quick setup',
      recommended: 'Recommended',
      quickHelp:
        'Scan a QR code and confirm in Telegram. Haishui creates the bot and detects your Telegram user ID automatically.',
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@haishui:example.org' },
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote Haishui you point it at, instead of this computer.',
      urlLabel: 'Remote address',
      urlPlaceholder: 'https://haishui.example.com',
    ...
    defaultDescription: 'Used when Haishui opens and for new chats. Existing sessions stay in their profiles.',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Haishui environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Haishui did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Haishui will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Haishui backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Haishui. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Haishui backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Haishui...',
    placeholderReconnecting: 'Reconnecting to Haishui…',
    ...
    voiceEngineChained: 'Speech-to-text + Haishui voice',
    voiceEngineLive: 'GPT-Live (full-duplex, delegates to Haishui)',
    ...
    attachUrlDesc: 'Haishui will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Haishui to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Haishui…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Haishui…',
    ...
    unsupportedMessage: 'This version of Haishui can’t update itself from inside the app.',
    connectionRetry:
      "Haishui couldn't reach the update server. Check your internet connection and try again. If you use a remote Haishui, make sure it is online.",
    gitUnusable: 'Haishui could not run Git on this computer, so it could not check for updates.',
    connectionSettings: 'Connection settings',
    ...
    manualBody: 'You installed Haishui from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Haishui will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Haishui desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Haishui updater takes over in its own window and reopens Haishui automatically when it’s done. Please don’t reopen Haishui yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Haishui reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Haishui reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Haishui?',
    blockerBody:
      'Haishui needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Haishui',
    foreignBlockerBody:
      'Haishui can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Haishui can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  handoffTour: {
    ...
    stayTitle: 'Haishui is one click away',
    stayText: 'Switch to the setup profile and open Welcome to Haishui whenever you want a hand. It stays there.'
  },
  guidedGreeting: {
    line: "Hey, come on in. I'm Haishui. Give me two minutes to set the place up around you, then we'll put me to work on something you actually want done.\n\nFirst though, what should I call you?",
  ...
  install: {
    ...
    oneTimeTitle: 'Haishui needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Haishui Desktop',
    setupChoiceDesc:
      'Connect this app to a Haishui gateway you already run, or install Haishui locally on this computer.',
    connectExistingTitle: 'Connect to existing Haishui',
    ...
    installLocalTitle: 'Install Haishui locally',
    installLocalDesc: 'Download Haishui, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Haishui Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Haishui',
    remoteSetupDesc: 'Enter your gateway URL. Haishui Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Haishui gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/haishui',
    ...
    settingUpTitle: 'Setting up Haishui Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the setup steps did not finish. This can happen when another copy of Haishui is running, the internet connection dropped, or antivirus blocked the installer. Close other Haishui windows, then choose Reload and retry. If it fails again, open the logs and send them to support.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Haishui Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Haishui is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Haishui…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Haishui',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Haishui at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Haishui connects automatically',
    ...
    authorizeThere: 'Authorize Haishui there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Haishui there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  freeTier: {
    ...
    retiredBody:
      'Your session ended before the sign-in finished. Haishui will start a new one; then sign in again whenever you\'re ready.',
    errorBody: "Sign-in didn't finish. Try again whenever you're ready.",
    busyHeading: 'Almost there',
    busyBody: wait =>
      `Haishui couldn't finish signing you in because the Nous service is busy. Try again in ${wait}. Your session is still here in the meantime.`,
    unreachableBody:
      "Haishui couldn't reach the Nous service to finish signing you in. Check your internet connection and try again. Your session is still here.",
    alreadySignedInHeading: 'Already signed in.',
    alreadySignedInBody: 'This Haishui is already signed in to a Nous account.',
    setupFailed: {
      gateClosed:
        "This version of Haishui can't start without a Nous account. Sign in or create one, it's free and only takes a minute.",
      paused:
        'Using Haishui without signing in is paused for a moment. Haishui will keep checking. Signing in is free and gets you going right now.',
      rateLimited: wait =>
        `Lots of people are getting started right now, so Haishui will try again in ${wait}. Signing in is free and skips the wait.`,
      unreachable:
        "Haishui couldn't reach the Nous service. Check your internet connection, then tap Try again. Or connect another provider for now.",
      ...
      generic: "Haishui couldn't set up free access without signing in. Signing in is free, or connect another provider.",
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Haishui Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Haishui Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Haishui will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Haishui is restarting...',
      askRestart: 'Ask Haishui to restart the server',
      lookingRestart: taskId => `Haishui is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Haishui is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Haishui to open a page.',
      finishedRestarting: message => `Haishui finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Haishui could not restart the server.',
      stillWorking:
        'Haishui is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Haishui is loading a response',
      ...
      errorLayers: {
        ...
        gateway: 'Haishui hit a problem',
        generic: "Haishui couldn't finish this reply",
        provider: 'The AI service returned an error',
        runtime: 'Haishui hit a problem',
      ...
      errorLayerBodies: {
        ...
        disk: 'Your disk is full, so Haishui could not save this conversation. Free some space, then retry.',
        endpoint: "Haishui can't reach your custom model server. Check that it is running, then send your message again.",
        gateway: 'Haishui hit an internal problem starting this reply. Send your message again; if it keeps happening, send diagnostics.',
        generic: 'Something went wrong while Haishui was replying. Retry, or copy the details if it keeps happening.',
        provider: 'The AI service could not complete this request. Retry in a moment or switch provider.',
        runtime: 'Haishui hit an internal problem starting this reply. Send your message again; if it keeps happening, send diagnostics.',
      ...
      errorCodes: {
        ...
        ssl_cert_verification: {
          ...
          body: provider =>
            `Haishui could not verify the secure connection to ${provider}. Check your network or proxy settings, or switch provider, then send your message again.`
        },
        context_overflow: {
        ...
        invalid_response: {
          ...
          body: provider => `${provider} returned something Haishui could not read. Retry in a moment.`
        },
        empty_response: {
        ...
        loop_error: {
          title: 'Haishui got stuck in a loop',
          body: 'The reply kept repeating the same steps, so Haishui stopped it. Retry, or start a new chat if it happens again.'
        },
        SESSION_NOT_OWNED: {
          title: 'This chat is open somewhere else',
          body: 'This chat is currently open in another Haishui window or terminal. Close it there and send your message again, or start a new chat here.'
        },
        disk_full: {
          title: 'Disk full',
          body: 'Your disk is full, so Haishui could not save this conversation. Free some space, then retry.'
        },
        ...
        free_tier_disabled: {
          title: 'Using Haishui without signing in is switched off right now',
        ...
        free_tier_model_not_free: {
          ...
          body: "Haishui uses the free model for now. Sign in with a Nous account for more models, it's free."
        },
        free_tier_route: {
          title: "Haishui couldn't reach the free model on this route",
        ...
        free_tier_refused: {
          title: "Haishui couldn't send that without signing in",
      ...
      errorToastTitle: "Haishui couldn't finish the reply",
      errorRetry: 'Retry',
      ...
      errorOpenHaishuiFolder: 'Open Haishui folder',
      errorOpenHaishuiFolderFailed: 'Could not open the Haishui folder',
    ...
    approval: {
      gatewayDisconnected:
        'Haishui is offline right now. The command is still waiting for your answer (until the approval timeout). Reconnect, then send it again.',
      sendFailed: 'Could not send your answer',
      reconnect: 'Reconnect',
      timedOutSystemLine:
        'Approval timed out — the command was not run. Ask Haishui to try again, or raise the limit in Settings → Safety → Approval timeout.',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.haishui/config.yaml). Haishui won’t ask again for commands like this — in this session or any future one.`,
      alwaysAllow: 'Always allow'
    },
    clarify: {
      notReady: 'Clarify request is not ready yet',
      gatewayDisconnected: 'Haishui is offline right now. Reconnect, then send it again.',
  ...
  prompts: {
    ...
    secretDesc: 'Haishui needs a credential to continue.',
    ...
    vaultSaveDesc: origin =>
      `Haishui reached a sign-in page at ${origin} and has no login for it. Enter it once here; it is encrypted on this machine and filled into the page without the model ever seeing the password.`,
    ...
    vaultCodeDesc: site =>
      `${site} is asking for a one-time code (text message, email or authenticator app). Enter it here and Haishui types it into the page; the model never sees it.`,
    vaultCodeLabel: 'Code',
    vaultCodeFootnote:
      'Tip: save the authenticator key with this login in Settings → Passwords & Logins and Haishui enters codes for you.',
    vaultCodeSkip: 'Skip',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Haishui Desktop to use Save Image.',
    restartToSaveImages: 'Restart Haishui Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: "Haishui couldn't reach your messaging connection. Start it from Settings → Messaging, then try the handoff again.",
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions Haishui loads when the work calls for them.'
      },
      messaging: {
        title: 'Haishui away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything Haishui made',
      ...
      profiles: {
        ...
        text: 'Each one is its own Haishui — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
