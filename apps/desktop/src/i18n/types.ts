...
export interface Translations {
  ...
  boot: {
    ...
    steps: {
      ...
      startingHaishuiDesktop: string
    }
    errors: {
      backgroundExited: string
      backgroundExitedDuringStartup: string
      backendStopped: string
      restartHaishui: string
      openLogs: string
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshHaishuiPathTitle: string
      sshHaishuiPathDesc: string
      sshHaishuiPathPlaceholder: string
  ...
  commandCenter: {
    ...
    haishuiActiveSessions: (version: string, count: number) => string
  ...
  freeTier: {
    ...
    // One sentence per backend code (`haishui_cli/anon_auth.py::ANON_*`); the copy never says
    // the free MODEL is off — what is unavailable is using Haishui without signing in.
    setupFailed: {
      gateClosed: string
      paused: string
  ...
  assistant: {
    thread: {
      ...
      errorOpenHaishuiFolder: string
      errorOpenHaishuiFolderFailed: string
