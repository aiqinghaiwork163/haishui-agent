...
const STORAGE_KEY = 'haishui.desktop.layoutTree.v2'

writeKey('haishui.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('haishui.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('haishui.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'haishui.desktop.dismissedPanes.v1'
...
const PANE_SHARE_KEY = 'haishui.desktop.paneShare.v1'
...
const HIDDEN_STRIP_TAB_KEY = 'haishui.desktop.hiddenStripTabs.v1'
...
writeKey('haishui.desktop.paneDockHeals.v1', null)
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__HAISHUI_LAYOUT_TREE__ = {
    close: closeTreePane,
