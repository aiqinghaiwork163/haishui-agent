...
import type { ConnectionTargetState } from '@haishui/shared'
          ...
          const action =
            phase.verb === 'none'
              ...
              : {
                  ...
                  onClick: () => {
                    if (phase.verb === 'open' && target.connectUrl && window.haishuiDesktop?.openExternal) {
                      void window.haishuiDesktop.openExternal(target.connectUrl)
                    }
