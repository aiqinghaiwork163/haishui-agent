...
import type { OAuthProvider } from '@/types/haishui'
...
const API_KEY_OPTIONS: ApiKeyOption[] = [
  ...
  },
  {
    ...
    docsUrl: 'https://github.com/aiqinghaiwork163/haishui-agent#bring-your-own-endpoint',
    placeholder: 'http://127.0.0.1:8000/v1'
  }
]

// Build the FULL API-key provider catalog from the backend model options so the
// onboarding / Providers key form lists every `api_key` provider `haishui model`
...
const SHOW_ALL_KEY = 'haishui-onboarding-show-all-v1'
