import type { ModelOptionProvider, ModelPricing } from '@haishui/shared'
import { fuzzyRank, modelSearchText } from '@haishui/shared'
...
export function ModelPickerDialog({
  ...
  // it: an empty query shows the curated list verbatim (like the `haishui
