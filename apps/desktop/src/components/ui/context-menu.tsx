...
export const HAISHUI_CONTEXT_MENU_TRIGGER_ATTR = 'data-haishui-context-menu-trigger'

function ContextMenuTrigger({ ...props }: React.ComponentProps<typeof ContextMenuPrimitive.Trigger>) {
  return (
    <ContextMenuPrimitive.Trigger data-slot="context-menu-trigger" {...props} data-haishui-context-menu-trigger="" />
  )
}
