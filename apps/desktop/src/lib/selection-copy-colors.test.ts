...
describe('installSelectionCopyColorGuard', () => {
  beforeEach(() => {
    document.documentElement.dataset.haishuiMode = 'dark'
  })

  afterEach(() => {
    delete document.documentElement.dataset.haishuiMode
    window.getSelection()?.removeAllRanges()
  })
  ...
  it('leaves light-ink selections alone when the theme is light', () => {
    document.documentElement.dataset.haishuiMode = 'light'
