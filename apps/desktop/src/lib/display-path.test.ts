...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/haishui-agent')).toBe('~/www/haishui-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/haishui-agent')).toBe('haishui-agent')
    expect(pathLeaf('~/www/haishui-agent')).toBe('haishui-agent')
