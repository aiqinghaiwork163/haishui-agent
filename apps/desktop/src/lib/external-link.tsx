...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|haishui):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.haishuiDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.haishuiDesktop?.openExternal?.(href)
  }
}
 ...
 * doesn't cost a context switch out of Haishui, and it is the surface the agent
