...
import type * as HaishuiApi from '@/haishui'
...
vi.mock('@/haishui', async importOriginal => ({
  ...(await importOriginal<typeof HaishuiApi>()),
...
describe('SkillsView toolset management', { timeout: 60_000 }, () => {
  ...
  it('offers (connection, profile) scope rows on multi-connection desktops', async () => {
    ...
    ;(window as { haishuiDesktop?: unknown }).haishuiDesktop = { connections, getAgentRoster }
