import type { ModelOptionProvider, ModelOptionsResult } from '@haishui/shared'
import { DEFAULT_REASONING_EFFORT } from '@haishui/shared'
...
import { getLocalModelsStatus } from '@/haishui'
...
import type { LocalModelLoadProgress } from '@/types/haishui'
 ...
 * Returning `{}` is fine — the row then shows Haishui' defaults.
 */
