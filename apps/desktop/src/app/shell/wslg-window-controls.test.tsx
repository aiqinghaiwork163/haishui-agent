...
const originalHaishuiDesktop = desktopWindow.haishuiDesktop
...
afterEach(() => {
  ...
  if (originalHaishuiDesktop) {
    desktopWindow.haishuiDesktop = originalHaishuiDesktop
  } else {
...
describe('WslgWindowControls', () => {
  it('routes minimize, maximize and close through the desktop bridge', () => {
    desktopWindow.haishuiDesktop = { windowControls } as unknown as Window['haishuiDesktop']
