...
export interface TitlebarChromeContext {
  ...
  windowButtonPosition?: HaishuiConnection['windowButtonPosition']
}
...
export function titlebarControlsPosition(
  windowButtonPosition: HaishuiConnection['windowButtonPosition'] | undefined,
  isFullscreen = false
) {
...
export const TITLEBAR_CHROME_CHANGED_EVENT = 'haishui:titlebar-chrome-changed'
