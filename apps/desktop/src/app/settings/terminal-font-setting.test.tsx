...
vi.mock('@/haishui', () => ({
  saveHaishuiConfig: (config: Record<string, unknown>) => mocks.save(config)
}))
...
vi.mock('../hooks/use-config-record', () => ({
  setHaishuiConfigCache: (config: Record<string, unknown>) => mocks.cache(config),
  useHaishuiConfigRecord: () => ({ data: mocks.loadedConfig, dataUpdatedAt: mocks.configUpdatedAt })
}))
