...
import { saveMemoryProviderConfig } from '@/haishui'
import { ExternalLink, Loader2, Save, SlidersHorizontal } from '@/lib/icons'
import { notify, notifyError } from '@/store/notifications'
import { $activeGatewayProfile } from '@/store/profile'
import type { MemoryProviderConfig, MemoryProviderField } from '@/types/haishui'
          ...
          {config.docs_url && (
            <a
              ...
              onClick={event => {
                ...
                void window.haishuiDesktop?.openExternal?.(config.docs_url)
              }}
              rel="noreferrer"
              target="_blank"
            >
