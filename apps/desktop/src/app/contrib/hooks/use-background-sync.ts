...
import { getLatestSessionMessages, type ProfileScope } from '@/haishui'
...
interface BackgroundSyncParams {
  ...
  refreshHaishuiConfig: () => Promise<unknown> | unknown
...
export function useBackgroundSync({
  ...
  }, [activeSessionId, freshDraftReady, gatewayState, refreshCurrentModel, refreshHaishuiConfig])
}
