...
const desktopWindow = window as unknown as { haishuiDesktop: unknown }
const originalBridge = desktopWindow.haishuiDesktop
...
afterEach(() => {
  ...
  desktopWindow.haishuiDesktop = originalBridge
})
