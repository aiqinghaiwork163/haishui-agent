...
import { listAllProfileSessions, listSidebarSessions, type SessionInfo } from '@/haishui'
...
// dispatcher workers are read on the board, finite one-shot runs (`haishui -z`,
