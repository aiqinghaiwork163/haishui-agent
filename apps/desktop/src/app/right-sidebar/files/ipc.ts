...
import type { HaishuiReadDirEntry, HaishuiReadDirResult } from '@/global'
...
export type ProjectTreeEntry = HaishuiReadDirEntry
...
function ignoredBy(rules: GitignoreRule[], entry: HaishuiReadDirEntry) {
...
async function filterIgnored(entries: HaishuiReadDirEntry[], rootPath: string, dirPath: string) {
...
export async function readProjectDir(dirPath: string, rootPath = dirPath): Promise<HaishuiReadDirResult> {
