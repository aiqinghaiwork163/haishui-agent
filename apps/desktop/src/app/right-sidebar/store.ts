...
const TAKEOVER_KEY = 'haishui.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Haishui can't clear via the API — the user
 *  sees exactly what runs instead of Haishui silently deleting their creds. */
