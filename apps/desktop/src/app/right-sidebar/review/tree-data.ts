import type { HaishuiReviewFile } from '@/global'
...
export function buildReviewFlatList(files: HaishuiReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: HaishuiReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
