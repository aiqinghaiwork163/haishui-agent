...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/haishui'
...
const VERSION = 3
const PREFIX = 'HML' // "Haishui Memory Loadout" — namespaces our codes like WoW's leading bytes.
