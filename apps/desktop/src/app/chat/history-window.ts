...
import { capabilityScoped, haishuiApi, type ProfileScope } from '@/api/client'
...
import type { SessionMessagesResponse } from '@/types/haishui'
...
export async function fetchHistoryWindow(
  ...
  const response = await haishuiApi<HistoryWindowResponse>({
    ...route,
