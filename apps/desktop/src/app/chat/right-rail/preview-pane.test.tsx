...
describe('PreviewPane console state', () => {
  ...
  it('continues comment numbering in one conversation and resets it when the conversation changes', async () => {
    ...
    const previousDesktop = window.haishuiDesktop
    let captureCount = 0
    ...
    window.haishuiDesktop = previousDesktop
  })
...
describe('PreviewPane guest external handoff', () => {
  ...
  // reaches the OS browser only through the audited `haishui:openExternal` IPC.
  ...
  async function renderWebview() {
    ...
    desktopWindow.haishuiDesktop = { openExternal } as unknown as Window['haishuiDesktop']
