...
import { saveHaishuiConfigRecord } from '@/haishui'
...
export function RealProfileConsentDialog({ tabId }: RealProfileConsentDialogProps) {
  ...
  const { data: config } = useHaishuiConfigRecord()
  const setConfig = haishuiConfigCacheWriter()
  ...
  const enable = useCallback(async () => {
    ...
    try {
      ...
      await saveHaishuiConfigRecord({ browser: { use_real_profile: true } })
