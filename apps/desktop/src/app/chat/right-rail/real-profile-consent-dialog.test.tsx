...
vi.mock('@/haishui', () => ({
  saveHaishuiConfigRecord: (config: Record<string, unknown>, profile?: unknown) => mocks.save(config, profile)
}))

const promptCopy = {
  title: 'Stay signed in to your sites',
  body: 'Let Haishui browse with a snapshot of your default browser profile.',
...
vi.mock('../../hooks/use-config-record', () => ({
  haishuiConfigCacheWriter: () => (config: Record<string, unknown>) => mocks.cache(config),
  useHaishuiConfigRecord: () => ({ data: mocks.loadedConfig })
}))
