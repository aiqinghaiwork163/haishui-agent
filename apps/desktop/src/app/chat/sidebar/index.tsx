...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/haishui'
...
// highlight markers (sqlite snippet() delimiters — see haishui_state_search.py).
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('haishui:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('haishui:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Haishui to
