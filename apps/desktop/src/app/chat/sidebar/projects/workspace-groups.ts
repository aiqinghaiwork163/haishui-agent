...
import type { ProjectInfo, SessionInfo } from '@/haishui'
 ...
 * repo shows its branches/worktrees even when they have no Haishui sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: HaishuiGitWorktree[]
): SidebarSessionGroup[] {
