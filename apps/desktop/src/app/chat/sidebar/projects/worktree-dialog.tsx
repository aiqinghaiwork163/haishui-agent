...
import type { HaishuiGitBranch } from '@/global'
...
const branchActionLabel = (branch: HaishuiGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<HaishuiGitBranch[]>([])
  ...
  const convert = async (branch: HaishuiGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
