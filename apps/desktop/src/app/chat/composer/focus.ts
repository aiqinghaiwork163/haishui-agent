...
const FOCUS_EVENT = 'haishui:composer-focus'
const INSERT_EVENT = 'haishui:composer-insert'
const ATTACH_IMAGES_EVENT = 'haishui:composer-attach-images'
const INSERT_REFS_EVENT = 'haishui:composer-insert-refs'
const SUBMIT_EVENT = 'haishui:composer-submit'
const VOICE_TOGGLE_EVENT = 'haishui:composer-voice-toggle'
const MODEL_MENU_EVENT = 'haishui:composer-model-menu'
