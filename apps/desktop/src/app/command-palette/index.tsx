...
import { getHaishuiConfigRecord, listAllProfileSessions } from '@/haishui'
...
// Haishui session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
...
function CommandPaletteBody({ onExited }: { onExited: () => void }) {
  ...
  const configQuery = useQuery({
    ...
    queryFn: () => getHaishuiConfigRecord()
  })
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-haishui',
            keywords: ['update', 'upgrade', 'haishui', 'version', 'system', 'restart'],
            label: cc.updateHaishui,
