...
import { ackStoredSessionId, atom, haptic, host, markSessionUnreadFinished } from '@haishui/plugin-sdk'
 ...
 *  (haishui-agent#90102) and are discarded. Without `canonical_session` (older
