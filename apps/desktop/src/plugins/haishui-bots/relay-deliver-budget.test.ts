...
const relaySource = readFileSync(join(process.cwd(), 'src/plugins/haishui-bots/relay.ts'), 'utf8')
const repoRoot = join(process.cwd(), '..', '..')
const configDefaults = readFileSync(join(repoRoot, 'haishui_cli/config_defaults.py'), 'utf8')
