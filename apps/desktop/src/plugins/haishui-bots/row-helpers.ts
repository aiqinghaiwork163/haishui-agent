...
import { atom, host, useValue } from '@haishui/plugin-sdk'
...
export function previewKind(preview: null | string | undefined): { fromBot: null | string } {
  ...
  if (match) {
    ...
    // profile reads @haishui, never @default (#89484).
 ...
 *  (haishui-agent#90268). Older gateways omit worker_session — always false. */
