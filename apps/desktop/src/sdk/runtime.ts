 ...
 * plugins resolve `@haishui/plugin-sdk` through the vite alias; RUNTIME-loaded
...
// `sdk/runtime` — so a module-scope `{ __HAISHUI_PLUGIN_SDK__: sdk, … }` is
...
// `Object.keys(GLOBALS.__HAISHUI_PLUGIN_SDK__)` threw
...
function pluginNamespaces() {
  return {
    __HAISHUI_PLUGIN_SDK__: sdk,
    __HAISHUI_REACT__: React,
    __HAISHUI_REACT_JSX__: jsxRuntime,
    __HAISHUI_REACT_JSX_DEV__: jsxDevRuntime
  }
}
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@haishui/plugin-sdk': shimUrl('__HAISHUI_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__HAISHUI_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__HAISHUI_REACT_JSX__'),
    react: shimUrl('__HAISHUI_REACT__')
  }
