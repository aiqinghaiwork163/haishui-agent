...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('haishui.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('haishui.desktop.unreadFinishedSessions')
