...
function identityForConnection(connection: HaishuiConnection | null): string {
  if (!connection) {
    return ''
  }
...
export function syncCronModelImpactConnection(connection: HaishuiConnection | null): void {
