...
import { cancelOAuthSession, listOAuthProviders, pollOAuthSession, startOAuthLogin } from '@/haishui'
...
// unreachable or refused mid sign-in (`haishui_cli/anon_sign_in.py`). Anything
...
/**
 * Drive one sign-in attempt end to end: resolve what identity this Haishui is
