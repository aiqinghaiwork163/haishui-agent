...
function installBridge(
  openSessionWindow?: Window['haishuiDesktop']['openSessionWindow'],
  openWindow?: Window['haishuiDesktop']['openWindow'],
  openBrowserWindow?: Window['haishuiDesktop']['openBrowserWindow']
) {
