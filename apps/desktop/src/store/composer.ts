...
export interface ComposerAttachment {
  ...
  thumbnailUrl?: string
  path?: string
  /** Bounded source text from a Haishui-generated large paste, sent only to the title path. */
  titlePreview?: string
...
export const SESSION_DRAFTS_STORAGE_KEY = 'haishui:composer-drafts:v3'
 ...
 */
const DRAFT_SYNC_EVENT = 'haishui:composer-draft-sync'
