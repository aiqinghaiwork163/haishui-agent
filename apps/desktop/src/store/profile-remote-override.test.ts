...
describe('remoteHostLabel', () => {
  it('keeps a non-default port and drops default ones', () => {
    expect(remoteHostLabel('https://haishui.example.com:8443/x')).toBe('haishui.example.com:8443')
    expect(remoteHostLabel('https://haishui.example.com:443')).toBe('haishui.example.com')
    expect(remoteHostLabel('http://haishui.example.com:80')).toBe('haishui.example.com')
  })
