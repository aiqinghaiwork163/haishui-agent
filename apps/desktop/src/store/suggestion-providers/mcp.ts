...
import { addMcpServer, getMcpCatalog, listMcpServers, removeMcpServer } from '@/haishui'
...
import type { McpCatalogEntry } from '@/types/haishui'
 ...
 * `haishui mcp catalog`), by whole-word keyword and pasted-link host suffix,
