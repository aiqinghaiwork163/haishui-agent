...
export const RECOVERY_ACTIONS = {
  restartHaishui: (): NotificationAction => ({
    label: translateNow('notifications.actions.restartHaishui'),
 ...
 *  (`haishui_state_errors.classify_persistence_error`). */
...
const ERROR_SUMMARIES: ErrorSummaryRule[] = [
  ...
  },
  {
    ...
    action: () => RECOVERY_ACTIONS.restartHaishui()
  },
  {
