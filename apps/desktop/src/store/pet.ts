...
export interface PetInfo {
  ...
  // the Haishui "run" activity state uses the in-place running row).
 ...
 * HAISHUI_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'haishui.desktop.pet-roam.v1'
