...
const POPOUT_STORAGE_KEY = 'haishui.desktop.composerPopout.window.v1'
const POPOUT_GESTURES_ENABLED_STORAGE_KEY = 'haishui.desktop.composerPopout.gesturesEnabled'
const ZONES_STORAGE_KEY = 'haishui.desktop.composerPopout.zones.v1'
const LEGACY_ENABLED_KEY = 'haishui.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'haishui.desktop.composerPopout.position'
