...
// v1 (`haishui.desktop.statusbarHidden`) was seeded with the approval pill
...
const STATUSBAR_HIDDEN_STORAGE_KEY = 'haishui.desktop.statusbarHidden.v2'
const LEGACY_HIDDEN_STORAGE_KEY = 'haishui.desktop.statusbarHidden'
// v1 (`haishui.desktop.statusbarVisible`) shipped a stretch where the bar was
...
const STATUSBAR_VISIBLE_STORAGE_KEY = 'haishui.desktop.statusbarVisible.v2'
