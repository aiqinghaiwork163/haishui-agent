...
import { getHaishuiConfigRecord, type McpTestResult, setMcpServerEnabled, testMcpServer } from '@/haishui'
...
const SNOOZE_KEY_PREFIX = 'haishui:mcp-health-snooze-until:'
...
async function sweep(): Promise<void> {
  ...
  try {
    config = await getHaishuiConfigRecord()
  } catch {
