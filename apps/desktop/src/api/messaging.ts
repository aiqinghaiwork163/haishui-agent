...
export function getMessagingPlatforms(profile?: null | string): Promise<MessagingPlatformsResponse> {
  return haishuiApi<MessagingPlatformsResponse>({
...
export function updateMessagingPlatform(
  ...
  return haishuiApi<MessagingPlatformUpdateResponse>({
    ...profileScoped(profile),
...
export function testMessagingPlatform(
  ...
  return haishuiApi<MessagingPlatformTestResponse>({
    ...profileScoped(profile),
...
export function startTelegramOnboarding(
  ...
  return haishuiApi<TelegramOnboardingStartResponse>({
    ...profileScoped(profile),
...
export function getTelegramOnboardingStatus(
  ...
  return haishuiApi<TelegramOnboardingStatusResponse>({
    ...profileScoped(profile),
...
export function applyTelegramOnboarding(
  ...
  return haishuiApi<TelegramOnboardingApplyResponse>({
    ...scope,
...
export function getPairing(profile?: null | string): Promise<PairingResponse> {
  return haishuiApi<PairingResponse>({
    ...profileScoped(profile),
    path: '/api/pairing'
  })
}
...
export function approvePairing(
  ...
  return haishuiApi<{ ok: boolean; user: PairingUser }>({
    ...scope,
...
export function getWebhooks(): Promise<WebhooksResponse> {
  return haishuiApi<WebhooksResponse>({
    ...profileScoped(),
    path: '/api/webhooks'
  })
}
...
export function enableWebhooks(): Promise<WebhookEnableResponse> {
  return haishuiApi<WebhookEnableResponse>({
    ...profileScoped(),
...
export function createWebhook(body: WebhookCreatePayload): Promise<WebhookCreateResponse> {
  return haishuiApi<WebhookCreateResponse>({
    ...profileScoped(),
    path: '/api/webhooks',
    method: 'POST',
    body
...
export function setWebhookEnabled(
  ...
  return haishuiApi<{ enabled: boolean; name: string; ok: boolean }>({
    ...profileScoped(),
