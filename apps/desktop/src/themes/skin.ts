/**
 * Haishui skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$HAISHUI_HOME/skins/` (or a
 * built-in) resolved by `haishui_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Haishui authors from a prompt lights up all three surfaces from one file.
 *
...
import { ensureContrast, mix } from '@haishui/shared/color'
import type { HaishuiSkin, SkinColors } from '@haishui/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: HaishuiSkin): DesktopTheme | null {
