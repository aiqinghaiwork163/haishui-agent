...
import { THEME_PRESET_PALETTES } from '@haishui/shared'
...
/**
 * Nous — the canonical Haishui desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays Haishui's own: a VS Code theme carries no font opinion, and
...
/**
 * Nous — the canonical Haishui desktop identity: GitHub's chrome carrying Nous
