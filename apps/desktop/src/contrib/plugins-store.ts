 ...
 * `<haishui home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'haishui.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'haishui.desktop.disabledPlugins.v1'
