...
// (#73044). Exercises the REAL haishui + store/gateway + store/profile chain:
...
const { pluginSocket, setApiRequestConnection, setApiRequestProfile } = await import('@/haishui')
...
const conn = (over: Partial<HaishuiConnection> = {}): HaishuiConnection =>
  ({
    authMode: 'oauth',
