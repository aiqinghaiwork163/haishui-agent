...
cd apps/desktop
XCURSOR_SIZE=24 HAISHUI_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/haishui-typing
# → /tmp/haishui-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/haishui-typing.before.heapsnapshot
# → /tmp/haishui-typing.after.heapsnapshot
```
