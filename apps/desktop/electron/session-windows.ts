...
// by main.ts (`setBackgroundThrottling` driven by the merged `haishui:active-work`
...
// (the "Haishui idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Haishui" wake word has NO preceding click,
