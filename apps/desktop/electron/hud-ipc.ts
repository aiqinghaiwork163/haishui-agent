...
export function registerHudIpc({
  ...
  ipcMain.on('haishui:hud:native-drag', event => {
    event.returnValue = hudWindowing().move === 'native-drag'
  })

  ipcMain.on('haishui:hud:windowing', event => {
  ...
  ipcMain.on('haishui:hud:workspace-transfer', (event, transferring) => {
  ...
  ipcMain.handle('haishui:hud:open', async (_event, request) => {
    openHudWindow(
  ...
  ipcMain.handle('haishui:hud:frost', (_event, showing) => {
  ...
  // reaches the bar.
  ipcMain.on('haishui:hud:ignore-mouse', (_event, ignore) => {
    const hudWindow = getHudWindow()
  ...
  ipcMain.on('haishui:hud:begin-move', event => {
    const hudWindow = getHudWindow()
  ...
  ipcMain.on('haishui:hud:end-move', event => {
    const hudWindow = getHudWindow()
  ...
  ipcMain.on('haishui:hud:move-by', (event, delta) => {
    const hudWindow = getHudWindow()
  ...
  ipcMain.on('haishui:hud:set-bounds', (event, bounds) => {
    const hudWindow = getHudWindow()
  ...
  ipcMain.handle('haishui:hud:reset-layout', event => {
    const hudWindow = getHudWindow()
  ...
  ipcMain.on('haishui:hud:session', (event, sessionId) => {
    const hudWindow = getHudWindow()
  ...
  ipcMain.handle('haishui:hud:close', async () => {
    closeHudWindow()
