 ...
 *     it via `haishui:profile:remember` without re-homing the primary.
 ...
 * the same HAISHUI_HOME. That duplicate held a pool slot and starved every other
...
export class PrimaryProfilePin {
  ...
  /** Called by startHaishui() with the profile the primary is launching as. */
