 ...
 * startHaishui() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startHaishui() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startHaishui`, re-emits
