...
// even though a fresh shell — and the Haishui CLI — sees it immediately. The
// desktop's HAISHUI_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\haishui. Reading
...
//       HAISHUI_HOME    REG_SZ    F:\Haishui\data
//
