 ...
 *
 * A public install can end up with `origin=git@github.com:NousResearch/haishui-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/NousResearch/haishui-agent.git'
