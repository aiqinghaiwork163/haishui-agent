 ...
 *
 * A public install can end up with `origin=git@github.com:aiqinghaiwork163/haishui-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/aiqinghaiwork163/haishui-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/aiqinghaiwork163/haishui-agent'
