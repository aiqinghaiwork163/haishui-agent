 ...
 * (`persist:haishui-remote-oauth`) — the jar was keyed on the auth *mode*, not
 ...
 * setup: one box, two dashboards) fought over the same `haishui_session*`
...
export const LEGACY_OAUTH_PARTITION = 'persist:haishui-remote-oauth'
...
// `Partitions/haishui-remote-oauth%3Aconn%3A<id>` folder is left on disk,
