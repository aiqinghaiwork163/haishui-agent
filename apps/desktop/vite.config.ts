...
export default defineConfig(({ command }) => ({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\haishui\haishui-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@haishui/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@haishui/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@haishui/shared/color': path.resolve(__dirname, '../shared/src/color.ts'),
      '@haishui/shared': path.resolve(__dirname, '../shared/src'),
