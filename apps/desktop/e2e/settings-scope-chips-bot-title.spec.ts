...
function seedProfile(haishuiHome: string, mockUrl: string, name: string, profileYaml: string): void {
...
test.beforeAll(async () => {
  ...
  // A Bot Mode bot: the roster shows ui_meta['haishui-bots'].title.
  seedProfile(sandbox.haishuiHome, mock.url, 'alpha', 'ui_meta:\n  haishui-bots:\n    title: Atlas Prime\n')
  // A renamed profile: `haishui profile rename` writes display_name.
  seedProfile(sandbox.haishuiHome, mock.url, 'beta', 'display_name: Beacon\n')
