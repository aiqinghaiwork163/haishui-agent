...
test.beforeAll(async () => {
  ...
  seedWriterProfile(fixture.sandbox.haishuiHome)
...
test('a DM addressed by the friendly name lands in that bot\'s Bot Chat', async () => {
  ...
  const home = fixture!.sandbox.haishuiHome
  ...
  // The recipient turn is a full `haishui -p writer` CLI boot in the background; its
