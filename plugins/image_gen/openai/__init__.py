        ...
        **kwargs: Any,
        ...
        if not api_key:
            return error_factory("openai", aspect)(
                "OPENAI_API_KEY not set. Run `haishui tools` → Image "
                "Generation → OpenAI to configure, or `haishui setup` "
                "to add the key.",
                "auth_required")
        ...
        # gpt-image bills per text/image token; the tier id is a Haishui label, the API model prices.
