...
def interactive_setup() -> None:
    ...
    from haishui_cli.cli_output import prompt, print_header, print_info, print_success
    ...
    print()
    info("📬 Home Channel: where Haishui delivers cron job results and notifications.",
    ...
    print_info("   Open config in your editor:  haishui config edit")
