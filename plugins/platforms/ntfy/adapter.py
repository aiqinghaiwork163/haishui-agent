...
_ECHO_TAG = "haishui-agent"  # tag added to outgoing messages for echo-loop prevention
...
def register(ctx) -> None:
    """Plugin entry point — called by the Haishui plugin system at startup."""
    ctx.register_platform(
        ...
        required_env=["NTFY_TOPIC"], install_hint="pip install httpx   # already a Haishui dependency",
