...
class NousProfile(ProviderProfile):
    ...
    def _cannot_disable_reasoning(model: str | None) -> bool:
        ...
        try:
            from haishui_cli.models_reasoning_caps import nous_model_reasoning_capabilities, warm_nous_reasoning_caps_async
...
nous = NousProfile(
    ...
    display_name="Nous Research", description="Nous Research — Haishui model family",
    signup_url="https://nousresearch.com/", fallback_models=("haishui-3-405b", "haishui-3-70b"),
