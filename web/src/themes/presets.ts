import { parseColor, THEME_PRESET_PALETTES, type ThemePresetPalette } from "@haishui/shared";
 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `haishui_cli/web_server.py`.
 *
 * Presets that also ship on the desktop (midnight, ember, mono, cyberpunk)
 * take their colours from `@haishui/shared` `THEME_PRESET_PALETTES` so both
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Haishui Teal",
  description: "Classic dark teal — the canonical Haishui look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Haishui Teal (Large)",
  description: "Haishui Teal with bigger fonts and roomier spacing",
