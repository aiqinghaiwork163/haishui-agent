...
const STORAGE_KEY = "haishui-dashboard-theme";
...
const FONT_STORAGE_KEY = "haishui-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `haishui_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "haishui-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-haishui-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-haishui-theme-font", "true");
