import { applyDocumentLocale, LOCALE_ENDONYMS } from "@haishui/shared/i18n";
...
// Display metadata for the language picker — endonyms from @haishui/shared so the
...
const STORAGE_KEY = "haishui-locale";
