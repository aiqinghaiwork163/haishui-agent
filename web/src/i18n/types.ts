...
export interface Translations {
  ...
  status: {
    ...
    updateHaishuiConfirmMessage?: string;
    updateHaishuiConfirmNow?: string;
    updateHaishuiConfirmTitle?: string;
    updatingHaishui: string;
  ...
  // ── Achievements plugin (plugins/haishui-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;
