...
export const en: Translations = {
  ...
  status: {
    ...
    updateHaishuiConfirmMessage:
      "This runs haishui update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateHaishuiConfirmNow: "Update now",
    updateHaishuiConfirmTitle: "Update Haishui?",
    updatingHaishui: "Updating Haishui…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Haishui plugins (`haishui plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.haishui/plugins/?",
    removeHint: "Only user-installed plugins under ~/.haishui/plugins can be removed.",
    ...
    catalogEmptyDocsLink: "Learn about Haishui plugins",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills installed yet. Browse the skills hub or create one here; from a terminal you can also run `haishui skills search <topic>`.",
  ...
  config: {
    configPath: "~/.haishui/config.yaml",
    filters: "Filters",
    sections: "Sections",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Haishui doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: "Haishui Achievements",
      subtitle:
        "Collectible Haishui badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Haishui session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Haishui more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Haishui sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Haishui is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Haishui Agent ☤",
    },
  },
