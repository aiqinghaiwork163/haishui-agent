 ...
 *
 * Plugins call window.__HAISHUI_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__HAISHUI_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__HAISHUI_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__HAISHUI_PLUGIN_SDK__ = {
    ...
    // window.__HAISHUI_SESSION_TOKEN__ directly.
    authedFetch,
