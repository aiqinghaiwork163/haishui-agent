 ...
 * `window.__HAISHUI_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Haishui brand in the top bar
 ...
 *  `window.__HAISHUI_PLUGINS__.registerSlot(...)`.
 *
