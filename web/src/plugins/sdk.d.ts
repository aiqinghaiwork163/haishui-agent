/**
 * Haishui Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__HAISHUI_PLUGIN_SDK__`` and
 * ``window.__HAISHUI_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__HAISHUI_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``HaishuiPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@haishui/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__HAISHUI_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__HAISHUI_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__HAISHUI_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface HaishuiPluginSDK {
...
declare global {
  interface Window {
    __HAISHUI_PLUGIN_SDK__?: HaishuiPluginSDK;
    __HAISHUI_PLUGINS__?: PluginRegistry;
  }
}
