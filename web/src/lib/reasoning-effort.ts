 ...
 *
 * Values come from @haishui/shared (haishui_constants.VALID_REASONING_EFFORTS
 * plus `none`, thinking-off). An empty/unset config value means the Haishui
 * default.
 */
 ...
 *  option. Empty/unknown → `medium` (Haishui' default when unset). */
