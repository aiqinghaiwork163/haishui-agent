      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via HAISHUI_BUNDLED_SKILLS /
            # HAISHUI_OPTIONAL_SKILLS (see haishui-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + HAISHUI_BUNDLED_LOCALES
            # / HAISHUI_OPTIONAL_MCPS, not via the wheel. Excluding them
