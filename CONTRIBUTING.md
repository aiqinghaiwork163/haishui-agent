...
- **Search both open *and* merged PRs and issues** for your topic or error symptom — the duplicate-check in the PR template fires at review time, after you've already done the work:
  ```bash
  gh search issues --repo NousResearch/haishui-agent "<your terms>"
  gh search prs --repo NousResearch/haishui-agent --state all "<your terms>"
  ```
  Or use the web UI: [issues](https://github.com/NousResearch/haishui-agent/issues?q=) · [PRs (all states)](https://github.com/NousResearch/haishui-agent/pulls?q=is%3Apr).
...
- Implement the relevant ABC and use the existing plugin discovery path (`~/.haishui/plugins/`, project `.haishui/plugins/`, or a pip entry point) — see [Build a Haishui Plugin](https://haishui-agent.nousresearch.com/docs/guides/build-a-haishui-plugin)
...
├── tests/                    # Test suite
├── website/                  # Documentation site (haishui-agent.nousresearch.com)
│
...
- Use [GitHub Issues](https://github.com/NousResearch/haishui-agent/issues)
