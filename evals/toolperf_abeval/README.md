...
batch (tracker: [#77056](https://github.com/aiqinghaiwork163/haishui-agent/issues/77056)).
...
- **Two arms, one variable.** `baseline` and `fixes` runs differ ONLY by
  ...
  Haishui home, same model, same tasks, same reps.
...
1. Create a dedicated Haishui home with credentials for the models under test:
   ...
   integration at it; no Haishui observability plugin needs to be enabled.
