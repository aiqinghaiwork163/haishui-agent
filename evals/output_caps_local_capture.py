...
Run from a checkout with HAISHUI_HOME pointing to a disposable directory.
"""
import json
import os
...
os.environ["HAISHUI_MAX_TOKENS"] = "13"
...
from haishui_cli.moa_config import _normalize_preset
