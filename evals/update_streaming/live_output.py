...
def step(mode):
    from haishui_cli.main_dashboard import _install_hangup_protection, _finalize_update_output
    from haishui_cli.main import _run_logged_subprocess
