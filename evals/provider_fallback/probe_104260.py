...
sandbox = tempfile.TemporaryDirectory(prefix="haishui-104260-")
os.environ.clear()
os.environ.update(
    HOME=sandbox.name,
    HAISHUI_HOME=sandbox.name + "/haishui",
    PATH="/usr/bin:/bin",
    PYTHONDONTWRITEBYTECODE="1",
    HAISHUI_DISABLE_MODEL_METADATA_FETCH="1",
)
...
# JSON is valid YAML; only the temporary Haishui home is written.
