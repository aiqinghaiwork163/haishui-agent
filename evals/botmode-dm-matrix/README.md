...
Scratch HOME, HAISHUI_HOME, Python facade and CLI shims; no user profiles or credentials.
...
(cd apps/desktop && HAISHUI_DESKTOP_CDP_PORT=off BOT_DM_SERVICE_PATH=1 \
...
worktree-pinned `haishui`; PATH contains a different inert `haishui` that exits 2
