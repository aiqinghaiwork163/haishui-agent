...
benchmarked ten harnesses on hostile-file handling — and whose Haishui column
...
Every task runs the full Haishui agent (file + terminal + search toolsets)
...
Rules of engagement (from haishuibench discipline):
