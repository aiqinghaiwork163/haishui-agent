...
def run_case(root, output, name, behind, early=False, cancel=False):
    with tempfile.TemporaryDirectory(prefix="haishui_test_notice_") as home:
        ...
        from haishui_cli.banner import VERSION
        ...
        bootstrap = ("import haishui_cli.main as m; import haishui_cli.banner as b; "
        ...
        try:
            ...
            result = {"case": name, "ready": ready, "exited": exited,
                      ...
                      "loaded_worktree": str(root / "haishui_cli/banner.py") in text,
