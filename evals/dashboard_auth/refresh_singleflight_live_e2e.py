...
os.environ["HAISHUI_HOME"] = tempfile.mkdtemp(prefix="haishui-e2e-55712-")
for m in [k for k in sys.modules if k.startswith(("haishui", "tools", "plugins"))]:
    del sys.modules[m]

import uvicorn  # noqa: E402

from haishui_cli import web_server  # noqa: E402
from haishui_cli.dashboard_auth import register_provider  # noqa: E402
from haishui_cli.dashboard_auth.base import RefreshExpiredError, Session  # noqa: E402
from tests.haishui_cli.conftest_dashboard_auth import StubAuthProvider  # noqa: E402
...
idp.calls = 0
ck = "haishui_session_at=expired-at; haishui_session_rt=cookie-stale; haishui_session_provider=stub"
with ThreadPoolExecutor(4) as pool:
