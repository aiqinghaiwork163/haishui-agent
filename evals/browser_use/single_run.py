...
The run gets a throwaway HAISHUI_HOME so no local config leaks in, and the
...
if _or_key:
    ...
    # Resolved by the orchestrator BEFORE HAISHUI_HOME is redirected to the
