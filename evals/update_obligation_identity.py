...
os.environ["HAISHUI_HOME"] = str(root / ".haishui")
from haishui_cli import update_cmd_fleet as fleet, update_receipt as receipts
...
try:
    for name in ["alpha", "beta"]:
        home = root / ".haishui" / "profiles" / name
    ...
    d = root / ".haishui/logs/update_receipts"
    ...
    home = root / ".haishui/profiles/beta"
