...
# Temp HAISHUI_HOME with the real auth + a config that shortens the generic sequential deadline to 40 s, so the
...
home = tempfile.mkdtemp(prefix="dl_home_"); os.environ["HAISHUI_HOME"] = home
real_home = os.environ.get("HAISHUI_HOME_SOURCE", os.path.expanduser("~/.haishui"))  # credentials are copied from here into a temp home
