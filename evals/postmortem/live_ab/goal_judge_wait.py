...
os.environ.setdefault("HAISHUI_HOME", os.path.expanduser("~/.haishui"))  # LIVE: real auxiliary judge calls (cents)
from haishui_cli import goals
goal = ("Simplify the haishui-agent codebase by >=30% LOC with zero behavior change, decomposing every god file, "
