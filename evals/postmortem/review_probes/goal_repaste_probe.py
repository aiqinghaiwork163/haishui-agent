...
# Remove all inherited Haishui/config and credential env before real imports.
...
os.environ['HAISHUI_HOME'] = home.name
os.environ['NO_PROXY'] = '*'
os.environ['TZ'] = 'UTC'
...
from haishui_cli import cli_commands_mixin, goals
...
server._haishui_home = Path(home.name)
...
with patch('haishui_cli.goals.draft_contract', return_value=None), contextlib.redirect_stdout(io.StringIO()):
