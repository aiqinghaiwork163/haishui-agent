...
await build({
  ...
  // Skip the prebuilt @haishui/ink bundle and inline the source instead:
  ...
  alias: { '@haishui/ink': resolve(root, 'packages/haishui-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The haishui_cli launcher
