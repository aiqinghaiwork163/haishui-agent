 ...
 * across theme x background scenes to <tmpdir>/haishui-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@haishui/ink'
...
// The regenerated slate light_colors block from haishui_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/haishui-agent',
...
const setup = (bgHex: string) => {
  process.env.HAISHUI_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
