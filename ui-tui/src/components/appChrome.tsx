import { Box, type ScrollBoxHandle, stringWidth, Text } from '@haishui/ink'
import { compactNumber } from '@haishui/shared/format'
import type { Usage } from '@haishui/shared/gateway-events'
...
export function StatusRule({
  ...
  // Dev-only readout (HAISHUI_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (HAISHUI_DEV_CREDITS), lowest priority,
