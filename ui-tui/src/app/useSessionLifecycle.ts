...
import type { ScrollBoxHandle } from '@haishui/ink'
import { evictInkCaches } from '@haishui/ink'
import type { InflightTurn, SessionResumeResult, Usage } from '@haishui/shared/gateway-events'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.HAISHUI_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
