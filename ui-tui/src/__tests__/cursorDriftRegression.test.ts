 ...
 *
 * Symptom: in `haishui --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@haishui/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using haishui --tui and as i type multiline my caret at the end will often ' +
