...
Data file: $HAISHUI_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_HAISHUI_HOME = Path(os.environ.get("HAISHUI_HOME", Path.home() / ".haishui"))
DATA_DIR = _HAISHUI_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
