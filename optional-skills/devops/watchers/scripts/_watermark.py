...
def _state_dir() -> Path:
    ...
    # Default: $HAISHUI_HOME/watcher-state/, falling back to ~/.haishui/watcher-state/.
    haishui_home = os.environ.get("HAISHUI_HOME") or str(Path.home() / ".haishui")
    return Path(haishui_home) / "watcher-state"
