#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Haishui docs site.
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Haishui as a Python Library", None),
        ("guides/use-mcp-with-haishui", "Use MCP with Haishui", None),
        ("guides/use-voice-mode-with-haishui", "Use Voice Mode with Haishui", None),
        ("guides/use-soul-with-haishui", "Use SOUL.md with Haishui", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Haishui"),
...
def emit_llms_index() -> str:
    ...
    lines.append("")
    lines.append(
        "Install: `curl -fsSL https://raw.githubusercontent.com/aiqinghaiwork163/"
        "haishui-agent/main/scripts/install.sh | bash`  "
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Haishui Agent — Full Documentation\n",
        (
            "This file is the entire Haishui Agent documentation concatenated for LLM "
