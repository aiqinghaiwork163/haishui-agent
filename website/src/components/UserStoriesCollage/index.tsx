  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Haishui Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Haishui &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Haishui?{' '}
        <a
          href="https://github.com/aiqinghaiwork163/haishui-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
          Add your story to this page
        </a>{' '}
        by editing <code>userStories.json</code>.
      </div>
    </div>
  );
}
