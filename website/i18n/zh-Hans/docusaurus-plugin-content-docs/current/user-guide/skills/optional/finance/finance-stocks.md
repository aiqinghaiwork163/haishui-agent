...
| | |
|---|---|
| 来源 | 可选 — 使用 `haishui skills install official/finance/stocks` 安装 |
| 路径 | `optional-skills/finance/stocks` |
| 版本 | `0.1.0` |
| 作者 | Mibay (Mibayy), Haishui Agent |
| 许可证 | MIT |
...
```
python3 ~/.haishui/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
