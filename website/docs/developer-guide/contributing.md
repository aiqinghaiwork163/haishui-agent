...
- **Profile-safe paths**: Never hardcode `~/.haishui` — use `get_haishui_home()` from `haishui_constants` for code paths and `display_haishui_home()` for user-facing messages. See [AGENTS.md](https://github.com/NousResearch/haishui-agent/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/NousResearch/haishui-agent/blob/main/LICENSE).
