...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `haishui_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `haishui_cli/` | [Extending the CLI](extending-the-cli.md) |
| Plugins system | `plugins/` | [Build a Haishui Plugin](plugins/index.md) |
...
| Session storage | `haishui_state.py`, `haishui_state_*.py` | [Session Storage](session-storage.md) |
