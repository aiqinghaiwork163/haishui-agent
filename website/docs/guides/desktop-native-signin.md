...
description: "How the Haishui Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the Haishui Desktop app connects to a **gated gateway** (a hosted or
...
For Haishui specifically, native sign-in means:
...
- [Run Haishui with Nous Portal](./run-haishui-with-nous-portal.md)
