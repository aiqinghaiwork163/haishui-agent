...
Ask Haishui to do this for you — the skill contains the full procedure — or do it manually:
...
- [Email gateway adapter](../user-guide/messaging/email.md) — chat with Haishui over email instead
