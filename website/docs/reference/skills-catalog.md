...
| [`haishui-agent`](../user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-haishui-agent.md) | Use, configure, theme, extend, and orchestrate Haishui Agent. | `autonomous-ai-agents/haishui-agent` |
...
| [`haishui-agent-skill-authoring`](../user-guide/skills/bundled/software-development/software-development-haishui-agent-skill-authoring.md) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development/haishui-agent-skill-authoring` |
| [`inspecting-haishui-desktop-dom`](../user-guide/skills/bundled/software-development/software-development-inspecting-haishui-desktop-dom.md) | Read the live Haishui desktop DOM/CSS over CDP. | `software-development/inspecting-haishui-desktop-dom` |
