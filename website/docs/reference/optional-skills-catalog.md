...
| [**honcho**](../user-guide/skills/optional/autonomous-ai-agents/autonomous-ai-agents-honcho.md) | Configure and troubleshoot Honcho memory for Haishui. |
...
| Skill | Description |
|-------|-------------|
| [**actual-setup**](../user-guide/skills/optional/devops/devops-actual-setup.md) | Set up Actual Computer (actual.inc) inference in Haishui. |
...
| [**haishui-s6-container-supervision**](../user-guide/skills/optional/devops/devops-haishui-s6-container-supervision.md) | Modify or debug s6 services in the Haishui Docker image. |
...
| Skill | Description |
|-------|-------------|
| [**openclaw-migration**](../user-guide/skills/optional/migration/migration-openclaw-migration.md) | Import an OpenClaw setup (memories, skills) into Haishui. |
