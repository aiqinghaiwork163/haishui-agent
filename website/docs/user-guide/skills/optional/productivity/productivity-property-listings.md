...
| | |
|---|---|
| Source | Optional — install with `haishui skills install official/productivity/property-listings` |
...
Present researched properties as browsable cards in the Haishui desktop transcript.
...
- A Haishui desktop conversation for native cards; the backend may be local or remote.
...
```text
haishui skills install official/productivity/property-listings
```
