...
| | |
|---|---|
| Source | Optional — install with `haishui skills install official/web-development/page-agent` |
...
- User wants **Haishui itself to drive a browser** → use Haishui' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
