...
| | |
|---|---|
| Source | Optional — install with `haishui skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Haishui Agent |
| License | MIT |
...
```
SCRIPT=~/.haishui/skills/finance/stocks/scripts/stocks_client.py
...
```
python ~/.haishui/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
