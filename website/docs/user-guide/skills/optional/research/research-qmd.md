...
| Related skills | [`obsidian`](../../bundled/note-taking/note-taking-obsidian.md), [`haishui-agent`](../../bundled/autonomous-ai-agents/autonomous-ai-agents-haishui-agent.md), [`arxiv`](../../bundled/research/research-arxiv.md) |
...
Haishui Agent via the native MCP client. This is the preferred
...
Then configure Haishui Agent to connect via HTTP:
