...
| | |
|---|---|
| Source | Optional — install with `haishui skills install official/research/blogwatcher` |
...
## Working with Haishui tools (read this first)

`blogwatcher-cli` is the feed database; Haishui tools do the automation around it:
