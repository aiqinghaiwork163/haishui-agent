...
| | |
|---|---|
| Source | Optional — install with `haishui skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Haishui Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
| License | MIT |
...
# $HAISHUI_OSINT_CACHE/icij/ (default: ~/.cache/haishui-osint/icij/).
...
# Set HAISHUI_OSINT_UA=your-app/1.0 (your@email) to identify yourself
