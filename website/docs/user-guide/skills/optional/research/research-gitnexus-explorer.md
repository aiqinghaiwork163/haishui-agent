...
| | |
|---|---|
| Source | Optional — install with `haishui skills install official/research/gitnexus-explorer` |
...
| Related skills | [`haishui-agent`](../../bundled/autonomous-ai-agents/autonomous-ai-agents-haishui-agent.md), [`codebase-inspection`](../../bundled/software-development/software-development-codebase-inspection.md) |
...
- **The web UI does NOT create `.claude/` or `CLAUDE.md`.** Those are created by
  ...
  haishui-agent users don't need.
