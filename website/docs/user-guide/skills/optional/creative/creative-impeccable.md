...
| | |
|---|---|
| Source | Optional — install with `haishui skills install official/creative/impeccable` |
...
> ships and verifies a Haishui-native skill bundle under `.haishui/skills/`.
> `haishui skills install impeccable` pulls the current bundle live from that
