...
| | |
|---|---|
| Source | Optional — install with `haishui skills install official/autonomous-ai-agents/openhands` |
| Path | `optional-skills/autonomous-ai-agents\openhands` |
| Version | `0.1.0` |
| Author | Tim Koepsel (xzessmedia), Haishui Agent |
| License | MIT |
| Platforms | linux, macos |
| Tags | `Coding-Agent`, `OpenHands`, `Model-Agnostic`, `LiteLLM` |
| Related skills | [`claude-code`](../../bundled/autonomous-ai-agents/autonomous-ai-agents-claude-code.md), [`codex`](../../bundled/autonomous-ai-agents/autonomous-ai-agents-codex.md), [`opencode`](../../bundled/autonomous-ai-agents/autonomous-ai-agents-opencode.md), [`haishui-agent`](../../bundled/autonomous-ai-agents/autonomous-ai-agents-haishui-agent.md) |
...
This skill is the headless-mode wrapper for batch / one-shot delegation. The interactive textual UI is not used from Haishui.
...
For Claude-native, prefer `claude-code`. For OpenAI-native, prefer `codex`. For Haishui-native subagents, use `delegate_task`.
...
- Sibling skills: `claude-code` (Anthropic-only), `codex` (OpenAI-only), `opencode` (multi-provider via OpenCode), `haishui-agent` (Haishui subagents via `delegate_task`).
