...
| | |
|---|---|
| Source | Optional — install with `haishui skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Haishui Agent |
| License | MIT |
...
Helper script path: `~/.haishui/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.haishui/skills/blockchain/evm/scripts/evm_client.py
...
python ~/.haishui/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python ~/.haishui/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
