...
The script reads `${HAISHUI_HOME:-~/.haishui}/.env` for two optional defaults:
...
Helper script: `~/.haishui/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python ~/.haishui/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${HAISHUI_HOME:-~/.haishui}/.env`.
...
```bash
python ~/.haishui/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.haishui/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
