...
| | |
|---|---|
| Source | Optional — install with `haishui skills install official/blockchain/solana` |
| Path | `optional-skills/blockchain\solana` |
| Version | `0.2.0` |
| Author | Deniz Alagoz (gizdusum), enhanced by Haishui Agent |
| License | MIT |
...
Helper script path: ~/.haishui/skills/blockchain/solana/scripts/solana_client.py
...
python ~/.haishui/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python ~/.haishui/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python ~/.haishui/skills/blockchain/solana/scripts/solana_client.py price BONK
python ~/.haishui/skills/blockchain/solana/scripts/solana_client.py price JUP
python ~/.haishui/skills/blockchain/solana/scripts/solana_client.py price SOL
python ~/.haishui/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
