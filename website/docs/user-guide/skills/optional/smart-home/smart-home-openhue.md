...
| | |
|---|---|
| Source | Optional — install with `haishui skills install official/smart-home/openhue` |
...
- Bridge must be on the same local network as the machine running Haishui
