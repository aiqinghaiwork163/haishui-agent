...
| | |
|---|---|
| Source | Optional — install with `haishui skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing haishui tool access (web_search, file ops). Stateless. |
