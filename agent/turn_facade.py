...
class TurnFacadeMixin:
    ...
    def run_conversation(
        ...
        from haishui_cli.observability.relay_shared_metrics import finish_task_run, start_task_run
        ...
        try:
            ...
            # A host that owns this thread (Haishui Console) may cancel the turn cross-thread.
