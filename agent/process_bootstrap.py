...
from haishui_bootstrap import _happy_eyeballs_create_connection
...
HAISHUI_TRANSPORT_OWNER_EXT = "haishui_transport_owner"
...
def _shared_transport_cls():
    ...
    class _SharedTransportImpl(httpx.BaseTransport):
        ...
        def handle_request(self, request: Any) -> Any:
            ...
            request.extensions[HAISHUI_TRANSPORT_OWNER_EXT] = id(self)
