...
A host that runs a blocking command on a worker thread (Haishui Console) never sees
...
_ACTIVE_SCOPE: ContextVar[Optional["InterruptScope"]] = ContextVar("haishui_interrupt_scope", default=None)
