...
_SESSION_CWD: ContextVar = ContextVar("HAISHUI_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    launch dir). An existing configured path is honored verbatim — including the Haishui source tree, a
    legitimate workspace when developing Haishui; fallback-directory policy lives in the caller."""
