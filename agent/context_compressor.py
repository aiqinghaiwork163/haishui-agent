...
_SUMMARY_ROUTE_PIN: contextvars.ContextVar[Optional[Dict[str, Any]]] = (
    contextvars.ContextVar("haishui_summary_route_pin", default=None)
)
...
# (haishui_state._rows_to_conversation), so any code that mutates a loaded or flushed dict's content in place
...
def _today_for_prompt() -> str:
    ...
    try:
        ...
        # via haishui_time.now(). The compaction summary is a mid-conversation message that is NOT part of
        ...
        return _haishui_now().strftime("%Y-%m-%d")
