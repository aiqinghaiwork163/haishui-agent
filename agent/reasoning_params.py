...
class ReasoningParamsMixin:
    ...
    def _supports_reasoning_extra_body(self) -> bool:
        ...
        try:
            from haishui_cli.models_reasoning_caps import openrouter_model_reasoning_capabilities, warm_openrouter_reasoning_caps_async
    ...
    def _lmstudio_reasoning_options_cached(self) -> list[str]:
        ...
        try:
            from haishui_cli.models_local import lmstudio_model_reasoning_options
        except Exception:
            return []
    ...
    def _ollama_supports_thinking_cached(self) -> bool:
        ...
        try:
            from haishui_cli.models_local import ollama_model_supports_thinking
        except Exception:
            return False
