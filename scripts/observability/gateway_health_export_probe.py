...
def main() -> None:
    ...
    haishui_home = Path(tempfile.mkdtemp(prefix="haishui-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "haishui-gateway-smoke",
    ...
    print(json.dumps({"haishui_home": str(haishui_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
