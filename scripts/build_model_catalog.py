#!/usr/bin/env python3
"""Build the Haishui Model Catalog — a centralized JSON manifest of curated models.
...
Haishui CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Haishui release.
...
# Ensure HAISHUI_HOME is set for imports that touch it at module level.
os.environ.setdefault("HAISHUI_HOME", os.path.join(os.path.expanduser("~"), ".haishui"))

from haishui_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "haishui-agent repo",
            "docs": "https://aiqinghaiwork163.github.io/haishui-agent/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Haishui '
