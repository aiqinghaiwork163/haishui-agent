...
DEFAULT_DATASETS = [
    ...
    "aiqinghaiwork163/haishui-agent-megascience-sft1",
    "NousResearch/Haishui-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Haishui-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-haishui-agent"
]
