...
_BASELINE = frozenset(
    {
        "tests/haishui_cli/test_doctor.py",
        "tests/haishui_cli/test_gateway.py",
        "tests/haishui_cli/test_gateway_proc_fallback.py",
        "tests/haishui_cli/test_linux_sandbox_fixup.py",
        "tests/haishui_cli/test_macos_fda_guidance.py",
        "tests/haishui_cli/test_orphan_desktop_serve_reap.py",
        "tests/haishui_cli/test_update_launchd_restart_verification.py",
        "tests/haishui_cli/test_update_launchd_unloaded_gateway.py",
        "tests/haishui_cli/test_urllib_security.py",
        "tests/haishui_state/test_state_synchronous_pragma.py",
        "tests/test_haishui_constants.py",
