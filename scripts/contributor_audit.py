...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Haishui\s+(Agent|Audit)$", re.IGNORECASE),
    ...
    re.compile(r".*\[bot\]$", re.IGNORECASE),             # any GitHub [bot] suffix (haishui-seaeye[bot] etc.)
...
IGNORED_EMAILS = {
    ...
    "haishui@nousresearch.com",
    "haishui-audit@example.com",
    "nousbot@nousresearch.com",
    "haishui@habibilabs.dev",
    "omx@oh-my-codex.dev",
    "codex@openai.com",
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "aiqinghaiwork163/haishui-agent",
                "--state", "merged",
