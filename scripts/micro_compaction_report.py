#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from Haishui logs.
...
With no LOGFILE, reads ``$HAISHUI_HOME/logs/agent.log`` (default ~/.haishui).
...
def default_log() -> Path:
    home = os.environ.get("HAISHUI_HOME") or str(Path.home() / ".haishui")
