#!/usr/bin/env python3
"""Build the Haishui Skills Index — a centralized JSON catalog of all skills.
...
`haishui skills search/install` can use it without hitting the GitHub API.
...
# Ensure HAISHUI_HOME is set (needed by tools/skills_hub*.py imports)
...
def main():
    print("Building Haishui Skills Index...", flush=True)
