...
Registry of record: `haishui_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore Haishui config+state snapshots (CLI)
...
/update                  Update Haishui to latest
