/**
 * Haishui desktop plugin template. Save as:
 *   <haishui home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <haishui home> is ~/.haishui by default, or ~/.haishui/profiles/<name>
 * when running a named profile (`haishui -p <name>`). Run `haishui doctor` (or
 ...
 * Only these imports resolve: @haishui/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@haishui/plugin-sdk'
