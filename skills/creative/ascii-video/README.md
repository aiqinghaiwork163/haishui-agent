...
Built for [Haishui Agent](https://github.com/NousResearch/haishui-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/haishui-agent/skills/creative/ascii-video`](https://github.com/NousResearch/haishui-agent/tree/main/skills/creative/ascii-video) via PR.
