...
Built for [Haishui Agent](https://github.com/aiqinghaiwork163/haishui-agent). Usable in any coding agent. Canonical source lives here; synced to [`aiqinghaiwork163/haishui-agent/skills/creative/ascii-video`](https://github.com/aiqinghaiwork163/haishui-agent/tree/main/skills/creative/ascii-video) via PR.
