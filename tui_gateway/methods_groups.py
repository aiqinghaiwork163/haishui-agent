...
_WORKER_UNAVAILABLE = "Group Chat worker is unavailable. Restart the Haishui gateway and try again."
...
def _profile_name() -> str:
    return (os.getenv("HAISHUI_PROFILE") or "default").strip() or "default"
