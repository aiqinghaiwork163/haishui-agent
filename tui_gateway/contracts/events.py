...
class SkinPayload(OpenPayload):
    """``tui_gateway/change_watcher.py::resolve_skin`` — the resolved active skin (``HaishuiSkin``).
...
class SetupReadyPayload(OpenPayload):
    """``haishui_cli/free_tier_bootstrap.py::SetupRecord.as_payload``."""
