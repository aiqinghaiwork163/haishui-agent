...
def _foreign_list(rid, params):
    from haishui_cli.foreign_sessions_browser import list_foreign_sessions
    try:
...
def _foreign_history_request(rid, params, importing):
    from haishui_cli.foreign_sessions_browser import import_browser_session, preview_foreign_session
    try:
