...
def _profile_user_agent() -> str:
    """Return a ``haishui-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from haishui_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"haishui-cli/{_ver}"
    except Exception:
        return "haishui-cli"
...
class ProviderProfile:
    ...
    # describe how to launch it; haishui_cli/auth.py's
    ...
    def create_client(self, **client_kwargs: Any) -> Any | None:
        ...
        a profile registered from ``~/.haishui/plugins/model-providers/`` or a
    ...
    def fetch_models(
        ...
        *,
        ...
        # haishui-cli UA so the catalog endpoint is reachable.
