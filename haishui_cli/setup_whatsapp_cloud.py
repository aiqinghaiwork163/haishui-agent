...
def run_whatsapp_cloud_setup() -> int:
    ...
    _lines(
        ...
        "This wizard configures Haishui to talk to WhatsApp via Meta's",
    ...
    _lines(
        "", "  Haishui needs a public HTTPS URL to receive WhatsApp messages.",
        ...
        "    3. Start the Haishui gateway in another terminal:",
        "         haishui gateway", "",
