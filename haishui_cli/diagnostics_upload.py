"""Client for uploading ``haishui debug share`` bundles to Nous-internal S3.
...
NAS_BASE = os.environ.get("HAISHUI_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com")
_REQUEST_TIMEOUT = 30
