...
from haishui_cli.kanban_db_connect import write_txn
from haishui_cli.kanban_pr_acceptance import _PR, collect_acceptance
...
def record_acceptance(conn, task_id, acceptance):
    ...
    from haishui_cli.kanban_db import _append_event
