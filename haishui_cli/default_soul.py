"""Default SOUL.md template seeded into HAISHUI_HOME on first run."""
...
DEFAULT_SOUL_MD = (
    "You are Haishui Agent, built by Nous Research. Be direct: match the length of your reply to the weight of "
...
_SCAFFOLD_HEAD = (
    "# Haishui Agent Persona\n\n<!--\nThis file defines the agent's personality and tone.\n"
    "The agent will embody whatever you write here.\nEdit this to customize how Haishui communicates with you.\n\n"
)
_SCAFFOLD_TAIL = (
...
_LEGACY_TEMPLATE_SOULS = (
    ...
    (
        "You are Haishui Agent, an intelligent AI assistant created by Nous Research. You are helpful, "
