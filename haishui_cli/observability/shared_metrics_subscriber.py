"""Relay subscriber for the persisted Haishui shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Haishui counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Haishui shared metric: %s", metric_name, exc_info=True
                )
