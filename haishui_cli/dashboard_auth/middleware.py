...
from haishui_cli.dashboard_auth import list_session_providers
from haishui_cli.dashboard_auth.audit import AuditEvent, audit_log
from haishui_cli.dashboard_auth.base import ProviderError
...
from haishui_cli.dashboard_auth.prefix import prefix_from_request
from haishui_cli.dashboard_auth.public_paths import PUBLIC_API_PATHS
from haishui_cli.dashboard_auth.refresh_singleflight import refresh_session_coalesced
from haishui_cli.dashboard_auth.request_utils import (
...
def _safe_next_target(request: Request) -> str:
    ...
    SPA's ``sessionStorage["haishui.lastLocation"]``."""
...
_PLUGIN_COMPAT_LAZY = {
    'DashboardAuthProvider': ('haishui_cli.dashboard_auth.base', 'DashboardAuthProvider'),
}
