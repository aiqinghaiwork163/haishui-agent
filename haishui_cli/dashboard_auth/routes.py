...
from haishui_cli.dashboard_auth import prefix as _prefix_mod
...
from haishui_cli.dashboard_auth.cookies import (
    ...
    set_session_cookies)
from haishui_cli.dashboard_auth.login_page import (
...
def _provider_pkce_segments(cookie_payload: dict[str, str]) -> dict[str, str]:
    ...
    flat = cookie_payload.get("haishui_session_pkce", "")
...
async def api_auth_ws_ticket(request: Request):
    ...
    sess = _require_session(request)
    from haishui_cli.dashboard_auth.ws_tickets import TTL_SECONDS, mint_ticket
