...
def build_gui_parser(subparsers, *, cmd_gui: Callable) -> None:
    ...
    gui_parser = subparsers.add_parser(
        ...
        description="Launch the Haishui Electron desktop app. By default this installs "
    ...
    gui_parser.add_argument(
        ...
        help="Force Desktop to ignore any haishui CLI already on PATH during backend resolution")
    gui_parser.add_argument(
        "--haishui-root",
        help="Override the Haishui source root used by Desktop (sets HAISHUI_DESKTOP_HAISHUI_ROOT)")
    gui_parser.add_argument(
        "--cwd",
        help="Initial project directory for Desktop chat sessions (sets HAISHUI_DESKTOP_CWD)")
    gui_parser.add_argument(
    ...
    gui_parser.add_argument(
        "--identity", default="Haishui Local Signing",
        help="Certificate name to create/use for --setup-tcc-identity (default: Haishui Local Signing)",
    )
