"""``haishui secrets`` subcommand parser."""
...
def build_secrets_parser(subparsers) -> None:
    ...
    from haishui_cli import secrets_cli as _secrets_cli
    from haishui_cli import onepassword_secrets_cli as _op_secrets_cli
