"""``haishui uninstall`` subcommand parser."""
...
def build_uninstall_parser(subparsers, *, cmd_uninstall: Callable) -> None:
    ...
    uninstall_parser = subparsers.add_parser(
        "uninstall", help="Uninstall Haishui Agent",
        description="Remove Haishui Agent from your system. Can keep configs/data for reinstall.")
