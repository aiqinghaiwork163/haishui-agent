"""Non-interactive HTTPS credentials for Haishui's internal git clones (private plugin/MCP/profile repos).
...
repo the user can already clone from their shell fails inside ``haishui plugins install`` with
