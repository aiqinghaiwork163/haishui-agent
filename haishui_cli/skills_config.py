"""Skills configuration for Haishui Agent. `haishui skills` enters this module."""
from typing import List, Optional, Set

from haishui_cli.config import cfg_get, load_config, save_config
from haishui_cli.colors import Colors, color
from haishui_cli.platforms import PLATFORMS as _PLATFORMS
...
def save_disabled_skills(config: dict, disabled: Set[str], platform: Optional[str] = None):
    """Persist disabled skill names to config; essential skills (e.g. ``haishui-agent``) are
...
def skills_command(args=None):
    """Entry point for `haishui skills`."""
    from haishui_cli.curses_ui import curses_checklist
    config = load_config()
