...
Invoked by ``haishui kanban decompose [task_id | --all]`` and the gateway
...
from haishui_cli.kanban_db_graph import decompose_triage_task
from haishui_cli import kanban_db_connect as kbc
from haishui_cli import profiles as profiles_mod
from haishui_cli.kanban_specify import (
    _call_aux, _extract_json_blob, _load_triage_task, _task_prompt_fields, _title_body,
)
from haishui_cli.kanban_specify import _profile_author as _specify_author

logger = logging.getLogger(__name__)


_SYSTEM_PROMPT = """You are the Kanban decomposer for the Haishui Agent board.
...
def _profile_author() -> str:
    """Mirror of ``haishui_cli.kanban._profile_author``."""
