...
from haishui_cli.web_server_dashboard import (
...
async def get_dashboard_themes():
    ...
    from `~/.haishui/dashboard-themes/*.yaml` ship their normalised `definition`."""
    def _run():
        config = load_config()
...
async def get_plugins_catalog(request: Request):
    ...
    def _run():
        from haishui_cli.plugins_cmd import _discover_all_plugins, _get_disabled_set, _get_enabled_set
        from haishui_cli.plugins_cmd_catalog import installed_catalog_state
        from haishui_cli.web_server_dashboard import _plugin_runtime_status
...
async def post_agent_plugin_install(request: Request, body: _AgentPluginInstallBody):
    _require_token(request)
    from haishui_cli.plugins_cmd import dashboard_install_plugin
...
async def post_agent_plugin_enable(request: Request, name: str):
    from haishui_cli.plugins_cmd import dashboard_set_agent_plugin_enabled
...
async def post_agent_plugin_update(request: Request, name: str):
    from haishui_cli.plugins_cmd import dashboard_update_user_plugin
...
async def delete_agent_plugin(request: Request, name: str):
    from haishui_cli.plugins_cmd import dashboard_remove_user_plugin
...
async def put_plugin_providers(request: Request, body: _PluginProvidersPutBody):
    ...
    _require_token(request)
    from haishui_cli.plugins_cmd import _save_context_engine, _save_memory_provider
