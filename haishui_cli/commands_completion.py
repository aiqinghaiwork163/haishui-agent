...
:mod:`haishui_cli.commands` (which re-exports both classes) so the registry module stays
...
from haishui_cli.commands import COMMANDS, SUBCOMMANDS
...
def _personality_completions(sub_text: str, sub_lower: str):
    ...
    from haishui_cli.personality import describe_personality
