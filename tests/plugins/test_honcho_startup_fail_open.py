...
@pytest.mark.parametrize("platform, present, absent", [
    ("cli", "haishui honcho peer --user", "Do not suggest peerName"),
    ("telegram", "Do not suggest peerName", "haishui honcho peer --user"),
])
...
@pytest.mark.parametrize("platform, present, absent", [
    ("cli", "haishui honcho peer --user", "could not be initialized"),
    ("discord", "supplied no user id", "haishui honcho peer --user"),
])
