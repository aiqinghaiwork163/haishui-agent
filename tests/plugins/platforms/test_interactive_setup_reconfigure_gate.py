...
gate through ``haishui_cli.setup_platforms.declines_reconfigure``.
...
import haishui_cli.setup_platforms as setup_platforms_mod
...
def test_declining_reconfigure_goes_through_shared_gate(monkeypatch, tmp_path, module_name, env_var):
    ...
    # haishui_cli.setup. Everything else a wizard could do after declining must not happen.
