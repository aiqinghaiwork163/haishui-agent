...
from haishui_cli.plugins import PluginManager, VALID_HOOKS


def _make_enabled_plugin(haishui_home: Path, name: str, register_body: str) -> Path:
    """Create a plugin under <haishui_home>/plugins/<name> and opt it in."""
    plugin_dir = haishui_home / "plugins" / name
...
def test_no_plugins_returns_empty_results(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("HAISHUI_HOME", str(tmp_path / "haishui_empty"))
