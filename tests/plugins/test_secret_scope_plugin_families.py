...
class TestGoogleMeetSpawn:
    def test_child_env_carries_scoped_openai_key(
        ...
        monkeypatch.delenv("HAISHUI_MEET_REALTIME_KEY", raising=False)
        ...
        assert child_env["HAISHUI_MEET_REALTIME_KEY"] == "scoped-openai-key"
    ...
    def test_explicit_key_argument_still_wins(
        ...
        assert captured["env"]["HAISHUI_MEET_REALTIME_KEY"] == "explicit-key"
