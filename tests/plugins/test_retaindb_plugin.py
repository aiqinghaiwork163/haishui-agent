...
def _isolate_env(tmp_path, monkeypatch):
    """Ensure HAISHUI_HOME and RETAINDB vars are isolated."""
...
class TestRetainDBMemoryProvider:
    ...
    def test_initialize_creates_client_and_queue(self, tmp_path, monkeypatch):
        ...
        p.initialize("test-session", haishui_home=str(tmp_path / ".haishui"))
...
class TestPrefetch:
    ...
    def _make_initialized_provider(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("HAISHUI_HOME", str(haishui_home))
        p = RetainDBMemoryProvider()
        p.initialize("test-session", haishui_home=str(haishui_home))
        return p
