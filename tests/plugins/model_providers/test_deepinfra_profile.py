...
against a gateway-wide enum (``none``..``max``; Haishui-internal ``ultra`` is rejected). The
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"enabled": True, "effort": "ultra"}, {"reasoning_effort": "max"}),  # Haishui-internal tier clamps
