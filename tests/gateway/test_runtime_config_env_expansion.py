...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("HAISHUI_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("HAISHUI_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("HAISHUI_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
