...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.haishui/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at haishui_state import time, before pytest's HAISHUI_HOME monkeypatch
    fires — the autouse fixture's HAISHUI_HOME override doesn't help here.)
    """
