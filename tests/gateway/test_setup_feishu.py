"""Tests for _setup_feishu() in haishui_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("haishui_cli.config.save_env_value", side_effect=mock_save), \
         patch("haishui_cli.config.get_env_value", side_effect=mock_get), \
         patch("haishui_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("haishui_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("haishui_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("haishui_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("haishui_cli.cli_output.print_header"), \
         patch("haishui_cli.cli_output.print_info"), \
         patch("haishui_cli.cli_output.print_success"), \
         patch("haishui_cli.cli_output.print_warning"), \
         patch("haishui_cli.cli_output.print_error"), \
