...
def _reset_fuzzy_cache(monkeypatch):
    ...
    # via _load_cfg(), which resolves through _haishui_home captured at module
    # import time — before the per-test HAISHUI_HOME redirect applies. When the
