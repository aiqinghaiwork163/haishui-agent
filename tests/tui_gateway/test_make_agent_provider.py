...
def test_apply_model_switch_does_not_leak_process_env():
    ...
    with (
        patch("haishui_cli.model_switch.parse_model_flags",
              return_value=("glm-5.1", None, False, False, True)),
        patch("haishui_cli.model_switch.resolve_persist_behavior",
              return_value=False),
        patch("haishui_cli.model_switch.switch_model", return_value=_FakeResult()),
        ...
        patch("haishui_cli.model_switch.persist_model_selection") as mock_persist,
    ):
