...
manipulation. Haishui keeps canonical conversation history in state.db and may
...
def fake_homes(tmp_path, monkeypatch):
    """Point HAISHUI_HOME at a temp profile dir.

    Uses the real env-var resolution chain (get_haishui_home /
    get_default_haishui_root) instead of monkeypatching private helpers —
    ...
    HAISHUI_HOME=<root>/profiles/<name> makes get_default_haishui_root()
