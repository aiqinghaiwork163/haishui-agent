...
class TestSummarizeToolResultClarify:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            # haishui_cli/oneshot.py no-user callback
    ...
    def test_live_oneshot_producer_is_recognized_as_sentinel(self):
        ...
        from haishui_cli.oneshot import _oneshot_clarify_callback
...
class TestAuthFailureAborts:
    ...
    def test_missing_provider_api_key_is_terminal_access_failure(self):
        ...
        oauth_err = RuntimeError(
            ...
            "Run `haishui auth add minimax-oauth` to sign in, or switch to a different provider "
            "with `haishui model`."
        )
    ...
    def test_missing_provider_api_key_preserves_original_messages(self):
        ...
        err = RuntimeError(
            ...
            "to a different provider with haishui model."
        )
        with patch(
...
class TestTruncateToolCallArgsJson:
    ...
    def test_shrunken_args_remain_valid_json(self):
        ...
        original = _json.dumps({
            "path": "~/.haishui/skills/shopping/browser-setup-notes.md",
        ...
        assert parsed["path"] == "~/.haishui/skills/shopping/browser-setup-notes.md"
