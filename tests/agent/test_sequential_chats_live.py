...
AlexKucera reported on Discord (2026-04-16) that after ``haishui update`` pulled
...
Opt-in — not part of default CI:
    HAISHUI_LIVE_TESTS=1 pytest tests/agent/test_sequential_chats_live.py -v

Requires ``OPENROUTER_API_KEY`` to be set (or sourced via ~/.haishui/.env).
"""
