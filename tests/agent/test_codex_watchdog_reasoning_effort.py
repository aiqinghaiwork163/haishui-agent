...
def _codex_agent(tmp_path: Path, monkeypatch, effort: str, *, enabled: bool = True):
    ...
    for var in ("HAISHUI_API_CALL_STALE_TIMEOUT", "HAISHUI_CODEX_TTFB_TIMEOUT_SECONDS",
                "HAISHUI_CODEX_EVENT_STALE_TIMEOUT_SECONDS", "HAISHUI_CODEX_TTFB_MAX_SECONDS"):
...
def test_default_effort_tiers_and_explicit_operator_values_are_untouched(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("HAISHUI_CODEX_EVENT_STALE_TIMEOUT_SECONDS", "20")
    monkeypatch.setenv("HAISHUI_CODEX_TTFB_TIMEOUT_SECONDS", "45")
    monkeypatch.setenv("HAISHUI_API_CALL_STALE_TIMEOUT", "75")
