...
Real imports, real temp HAISHUI_HOME root + named profile, real auth.json I/O.
...
def fleet(tmp_path, monkeypatch):
    """Root HAISHUI_HOME with an expired-but-refreshable Anthropic pool row."""
    ...
    haishui_constants._default_haishui_root_memo = None  # type: ignore[attr-defined]
    ...
    store = {
        ...
        "credential_pool": {
            "anthropic": [{
                ...
                "priority": 0, "source": "manual:haishui_pkce",
...
def test_strip_helper_fails_closed_when_root_store_cannot_be_resolved(fleet, monkeypatch):
    ...
    monkeypatch.setattr(
        haishui_constants, "get_default_haishui_root",
...
def test_profile_auth_add_owns_only_its_own_rows(fleet):
    ...
    pool.add_entry(PooledCredential(
        ...
        priority=0, source="manual:haishui_pkce", access_token="sk-ant-oat01-MINE",
