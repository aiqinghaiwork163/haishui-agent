...
thinking phase.  Haishui's default cloud-stream stale detector
(``HAISHUI_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``HAISHUI_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
