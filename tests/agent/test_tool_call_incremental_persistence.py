...
def _make_agent():
    haishui_home = Path(tempfile.mkdtemp(prefix="haishui-test-home-"))
    (haishui_home / "logs").mkdir(parents=True, exist_ok=True)
    with (
        patch(
        ...
        patch("run_agent._haishui_home", haishui_home),
