...
CA bundle env vars (HAISHUI_CA_BUNDLE, REQUESTS_CA_BUNDLE, SSL_CERT_FILE)
...
_CA_ENV_VARS = ("HAISHUI_CA_BUNDLE", "REQUESTS_CA_BUNDLE", "SSL_CERT_FILE")
...
class TestResolveRequestsVerify:
    ...
    def test_priority_haishui_over_requests(self, clean_env, tmp_path, bundle_file):
