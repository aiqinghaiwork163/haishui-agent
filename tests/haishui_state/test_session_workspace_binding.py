"""Session <-> workspace grouping key (haishui_state_sessions.workspace_key).

The key is what `haishui sessions list --workspace` groups/filters on. It is a
...
import haishui_state_sessions
from haishui_state_sessions import workspace_key
