"""The `haishui-agent` skill is what a running Haishui knows about itself.

`website/` is never packaged, so an installed Haishui has no local copy of the
user guide; skills ARE synced into `$HAISHUI_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "Haishui can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "haishui-agent"
