...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and haishui-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # haishui-agent (tests/skills/)
]
