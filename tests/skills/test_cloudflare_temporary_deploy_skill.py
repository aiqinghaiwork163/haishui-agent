...
class TestRealWorldOutput:
    ...
    REAL = (
        ...
        "Uploaded haishui-temp-hello (0.74 sec)\n"
        "Deployed haishui-temp-hello triggers (0.42 sec)\n"
        "  https://haishui-temp-hello.serene-temple.workers.dev\n"
    )
    ...
    def test_all_fields_from_real_output(self):
        r = pdo.parse(self.REAL)
        assert r["live_url"] == "https://haishui-temp-hello.serene-temple.workers.dev"
