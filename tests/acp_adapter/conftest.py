...
Keeps the ACP server tests offline: ``HaishuiACPAgent._build_model_state``
calls ``haishui_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import haishui_cli.inventory as inventory
