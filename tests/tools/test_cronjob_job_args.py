...
hardcoded "~/.haishui/scripts/" in its messages even though resolution goes
through get_haishui_home(), which is per-profile.
"""
...
class TestValidateCronScriptPath:
    ...
    def test_missing_file_error_names_the_resolved_scripts_dir(self):
        ...
        # under profiles, where get_haishui_home() is not the global ~/.haishui.
        scripts_dir = get_haishui_home() / "scripts"
