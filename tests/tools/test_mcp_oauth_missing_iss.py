...
from tools.mcp_oauth_provider import HaishuiProviderMixin  # noqa: E402


class _Provider(HaishuiProviderMixin, OAuthClientProvider):
    pass
...
def _provider_for(issuer: str, *, iss_in_redirect: str | None) -> _Provider:
    ...
    provider._haishui_oauth_flow = "browser"
    return provider
