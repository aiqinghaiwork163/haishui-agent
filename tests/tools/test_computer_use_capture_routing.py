...
* ``haishui_constants.get_haishui_dir`` (cache path)
...
def tmp_cache_dir(tmp_path):
    """Override get_haishui_dir so cache writes land under tmp_path."""
    ...
    with patch("haishui_constants.get_haishui_dir", _fake_get):
        yield cache_dir
