...
class TestWriteDenyExactPaths:
    ...
    def test_haishui_root_env_when_running_under_profile(self, tmp_path, monkeypatch):
        ...
        ``~/.haishui/.env`` (whose credentials are inherited by every profile)
        ...
        # Sanity check: HAISHUI_HOME does point to the profile dir, not the root.
        from haishui_constants import get_haishui_home, get_default_haishui_root
...
class TestWriteAllowed:
    ...
    def test_haishui_control_files_requested_writable(self):
