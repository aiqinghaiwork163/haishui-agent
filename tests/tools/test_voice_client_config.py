...
Real config files in a temp HAISHUI_HOME, real resolution chains (no mocked
...
def voice_home(tmp_path, monkeypatch):
    """Isolated HAISHUI_HOME + reloaded config modules; yields a config writer."""
    ...
    for var in (
        ...
        "DEEPINFRA_API_KEY", "HAISHUI_LOCAL_STT_LANGUAGE",
    ):
