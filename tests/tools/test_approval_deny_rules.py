...
def clean_env(monkeypatch):
    ...
    for var in ("HAISHUI_YOLO_MODE", "HAISHUI_GATEWAY_SESSION",
                "HAISHUI_CRON_SESSION", "HAISHUI_INTERACTIVE",
                "HAISHUI_EXEC_ASK"):
...
class TestDenyOrdering:
    ...
    def test_container_backend_cannot_skip_deny(
        ...
        result = guard("chmod 600 /tmp/haishui-approval-deny-test", env_type)
