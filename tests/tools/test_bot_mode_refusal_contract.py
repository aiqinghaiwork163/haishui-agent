...
def test_one_shot_cli_preserves_refusal_reason(monkeypatch, capsys):
    ...
    assert not HaishuiCLI._claim_active_session(cli, stderr=True)
    assert "haishui-refusal-reason: SESSION_NOT_OWNED\n" in capsys.readouterr().err
