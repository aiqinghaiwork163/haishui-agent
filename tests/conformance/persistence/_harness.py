...
def make_haishui_home(base: Path, journal_mode: str) -> Path:
    """Create an isolated HAISHUI_HOME whose config pins ``database.journal_mode``.
    ...
    """
    home = base / f"haishui-home-{journal_mode}"
