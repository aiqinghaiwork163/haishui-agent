...
the shared /blueprint command handler (haishui_cli/blueprint_cmd.py), and
the docs generator. Uses an isolated HAISHUI_HOME for anything that touches the
cron job store.
"""
...
class TestRenderers:
    ...
    def test_deeplink_shape(self):
        ...
        assert url.startswith("haishui://blueprint/morning-brief?")
