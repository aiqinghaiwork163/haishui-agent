...
The unit tests in tests/haishui_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned haishui-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/haishui")
from haishui_cli.service_manager import S6ServiceManager
