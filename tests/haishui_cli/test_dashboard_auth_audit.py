...
Profile-aware location: ``$HAISHUI_HOME/logs/dashboard-auth.log``.
...
from haishui_cli.dashboard_auth.audit import audit_log, AuditEvent


@pytest.fixture
def profile_home(tmp_path, monkeypatch):
    """Redirect $HAISHUI_HOME and ~ to a tmp dir for the duration of the test."""
