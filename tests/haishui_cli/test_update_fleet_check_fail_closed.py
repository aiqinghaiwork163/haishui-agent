...
``haishui update`` exited 0 with zero rows — even when a gateway was
...
from haishui_cli.main import _fleet_probe_expected_runtimes
from haishui_cli.update_inventory import RuntimeRecord
...
class TestEmptySnapshotFailClosed:
    ...
    def test_incomplete_when_restart_phase_touched_gateways(self):
        ...
        assert (
            _fleet_probe_expected_runtimes(None, [], None, ["haishui-gateway"], set())
            is True
        )
...
class TestCallSiteWiring:
    ...
    def test_settle_sleep_gated_on_expected_runtimes(self):
        ...
        from haishui_cli import update_cmd_fleet
...
def test_unmapped_stops_are_not_expected_rows():
    ...
    from haishui_cli.update_cmd_fleet import _GatewayRestartOutcome
