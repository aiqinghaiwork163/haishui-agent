...
from haishui_cli.dashboard_auth import refresh_singleflight as replay
from haishui_cli.dashboard_auth.base import ProviderError, RefreshExpiredError, Session
from haishui_cli.dashboard_auth.routes import router
...
def test_cookie_gate_burst_with_stale_rt_rotates_once(gated_web_app):
    ...
    cookies = {"haishui_session_at": "expired-at", "haishui_session_rt": "stale-rt",
               "haishui_session_provider": "stub"}
