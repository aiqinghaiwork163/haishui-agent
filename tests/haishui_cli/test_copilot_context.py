...
class TestGetCopilotModelContext:
    ...
    @patch("haishui_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("haishui_cli.models._urlopen_model_catalog_request")
    ...
    @patch("haishui_cli.models.fetch_github_model_catalog", return_value=[])
