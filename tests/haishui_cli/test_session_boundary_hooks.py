...
from haishui_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/haishui_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("haishui_cli.lifecycle.invoke_hook")
@patch("haishui_cli.lifecycle.finalize_session")
