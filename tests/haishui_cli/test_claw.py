"""Tests for haishui claw commands."""
...
from haishui_cli import claw as claw_mod
...
class TestCmdMigrate:
    ...
    def test_full_preset_does_not_enable_secrets_silently(self, tmp_path, capsys):
        ...
        even under the 'full' preset.  This mirrors OpenClaw's migrate-haishui
...
class TestPrintMigrationReport:
    ...
    def test_dry_run_report(self, capsys):
        report = {
            ...
            "items": [
                {"kind": "soul", "status": "migrated", "destination": "/home/user/.haishui/SOUL.md"},
                {"kind": "memory", "status": "migrated", "destination": "/home/user/.haishui/memories/MEMORY.md"},
