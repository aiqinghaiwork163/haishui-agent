"""Invariants for ``haishui_cli.config_effective.load_user_config_effective`` — the one loader every
defaults-free config reader (gateway runtime, TUI gateway, cron, ``haishui send`` bridge, doctor,
...
def _reset_caches():
    ...
    from haishui_cli import config_effective, managed_scope
