"""Tests for `_can_open_graphical_browser()` in haishui_cli.auth.

Guards the fix for the May 2026 report where `haishui auth add xai-oauth`
...
from haishui_cli.auth import _can_open_graphical_browser
