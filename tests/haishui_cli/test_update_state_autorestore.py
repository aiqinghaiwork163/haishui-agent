...
second Haishui holder the updater's drain did not stop — survives the copy and is
...
def test_post_update_guard_covers_sibling_profiles(tmp_path, monkeypatch, capsys):
    ...
    monkeypatch.setattr(update_cmd, "get_haishui_home", lambda: root_home)
    monkeypatch.setattr(
        "haishui_cli.backup._sibling_profile_homes",
