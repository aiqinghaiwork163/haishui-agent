"""Tests for `haishui chat --safe-mode` isolation."""
...
_VARS = ("HAISHUI_SAFE_MODE", "HAISHUI_IGNORE_USER_CONFIG", "HAISHUI_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["HAISHUI_SAFE_MODE"] == "1"
        assert os.environ["HAISHUI_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["HAISHUI_IGNORE_RULES"] == "1"
        return True
