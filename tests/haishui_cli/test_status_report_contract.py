...
Every surface renders through ``haishui_cli.status_report.build_status_fields``; each keeps
...
def test_three_status_surfaces_report_the_same_common_fields():
    with patch("haishui_constants.display_haishui_home", return_value=HOME), \
