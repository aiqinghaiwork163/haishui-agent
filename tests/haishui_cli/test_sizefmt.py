"""Tests for the shared byte formatter (haishui_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from haishui_cli.backup import _format_size as backup
    from haishui_cli.checkpoints import _fmt_bytes as checkpoints
    from haishui_cli.sizefmt import format_bytes as doctor
