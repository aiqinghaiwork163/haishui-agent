"""Tests for the ``haishui prompt-size`` diagnostic (issue #34667)."""
...
from haishui_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(haishui_home, memory_text="", user_text=""):
    mem_dir = haishui_home / "memories"
...
def _seed_skill(haishui_home, name, description):
    skill_dir = haishui_home / "skills" / "demo" / name
