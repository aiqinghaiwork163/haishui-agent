"""Tests for the shared tar.gz writer (``haishui_cli.archive_safe.make_targz``).

``make_targz`` backs both ``haishui profile export`` and ``haishui kanban
...
from haishui_cli.archive_safe import make_targz
