...
stale-module ImportError after ``haishui update``.
"""
...
import haishui_cli.web_routers.models as _rt_models
...
class TestModelSwitchSkewGuard:
    ...
    def test_guard_message_names_revs_and_restart(self, monkeypatch):
        ...
        assert "haishui gateway restart" in msg
...
class TestModelOptionsSkewGuard:
    ...
    def test_fresh_dashboard_builds_payload_unchanged(self, monkeypatch):
        ...
        monkeypatch.setattr("haishui_cli.inventory.load_picker_context", lambda: {})
