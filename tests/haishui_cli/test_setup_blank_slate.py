"""Tests for Blank Slate setup mode (haishui_cli/setup.py).
...
from haishui_cli.setup_quick import _blank_slate_minimal_toolsets, _blank_slate_minimize_config
