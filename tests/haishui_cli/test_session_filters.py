"""Tests for haishui_cli.session_filters — CLI time/filter parsing for
`haishui sessions prune` / `haishui sessions archive`."""
...
from haishui_cli.session_filters import (
    build_prune_filters,
    describe_filters,
