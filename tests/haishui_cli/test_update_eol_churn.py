"""Regression: ``haishui update`` should take a managed checkout off autocrlf=true.
...
``haishui update`` has to repair them.
...
from haishui_cli.update_cmd import _normalize_managed_eol
