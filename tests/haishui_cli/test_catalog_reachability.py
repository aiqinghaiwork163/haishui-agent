...
Run before any catalog commit:
    ...
    HAISHUI_TEST_NETWORK=1 scripts/run_tests.sh tests/haishui_cli/test_catalog_reachability.py
"""
...
pytestmark = pytest.mark.skipif(
    not os.environ.get("HAISHUI_TEST_NETWORK"),
    reason="network test; set HAISHUI_TEST_NETWORK=1 to run",
)
