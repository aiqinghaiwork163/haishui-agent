...
The canonical profile id ("default" for ~/.haishui) is never touched —
...
def profile_env(tmp_path, monkeypatch):
    """Isolated environment: Path.home() and HAISHUI_HOME under tmp_path."""
...
class TestMetaAndValidation:
    ...
    def test_bot_title_read_from_haishui_bots_ui_meta(self, profile_env):
        ...
        from haishui_cli.web_routers.profiles import _profile_to_dict
...
class TestRenameDefault:
    ...
    def test_named_rename_still_real_and_keeps_display_name(
        ...
        monkeypatch.setattr(
            "haishui_cli.profiles.check_alias_collision", lambda name: "skip"
        )
