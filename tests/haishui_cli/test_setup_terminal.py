"""Tests for haishui_cli/setup_terminal.py backend wizards."""

import pytest

from haishui_cli.config import save_env_value, get_env_value
from haishui_cli import setup as setup_mod
from haishui_cli import setup_terminal
