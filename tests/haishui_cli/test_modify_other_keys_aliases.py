...
from haishui_cli.pt_input_extras import install_modify_other_keys_aliases
...
def test_shift_symbol_data_normalized_in_buffer():
    ...
    from haishui_cli.pt_input_extras import install_keypress_data_normalization
...
def test_does_not_clobber_shift_enter_alias():
    ...
    from haishui_cli.pt_input_extras import install_shift_enter_alias
...
def test_does_not_clobber_ctrl_enter_alias():
    ...
    from haishui_cli.pt_input_extras import install_ctrl_enter_alias
...
def test_cmd_backspace_alias_not_clobbered():
    ...
    from haishui_cli.pt_input_extras import install_cmd_backspace_alias
...
def test_lock_bits_on_shift_enter_and_ctrl_enter_aliases():
    from haishui_cli.pt_input_extras import (
        install_ctrl_enter_alias,
        install_shift_enter_alias,
    )
    install_shift_enter_alias()
