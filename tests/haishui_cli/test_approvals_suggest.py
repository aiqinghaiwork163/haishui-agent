"""Tests for ``haishui approvals suggest`` (haishui_cli/approvals_suggest.py).

Approval history in Haishui is implied, not ledgered: the session DB
...
from haishui_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
