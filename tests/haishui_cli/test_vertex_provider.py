...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (haishui_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_haishui_overlays():
    """haishui_cli.providers.get_provider("vertex") backs
