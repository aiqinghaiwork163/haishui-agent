...
The oneshot path builds its AIAgent directly (bypassing HaishuiCLI), so the
...
from haishui_cli.oneshot import _build_preloaded_skills_prompt, _normalize_skills
