...
the *mutation* side: `haishui plugins enable/disable` must resolve a bare name
...
class TestResolvePluginKey:
    @patch("haishui_cli.plugins.get_bundled_plugins_dir")
    ...
    def test_full_key_resolves_to_itself(self, mock_user, mock_bundled, nested_plugin_env):
        from haishui_cli.plugins_cmd import _resolve_plugin_key
...
class TestEnableDisableNested:
    @patch("haishui_cli.plugins.get_bundled_plugins_dir")
    @patch("haishui_cli.plugins_cmd._plugins_dir")
    @patch("haishui_cli.plugins_cmd._save_disabled_set")
    @patch("haishui_cli.plugins_cmd._save_enabled_set")
    @patch("haishui_cli.plugins_cmd._get_disabled_set", return_value=set())
    @patch("haishui_cli.plugins_cmd._get_enabled_set", return_value=set())
...
class TestEnableToolOverrideConsent:
    ...
    @patch("haishui_cli.plugins.get_bundled_plugins_dir")
    @patch("haishui_cli.plugins_cmd._plugins_dir")
    @patch("haishui_cli.plugins_cmd._set_plugin_entry_flag")
    @patch("haishui_cli.plugins_cmd._save_disabled_set")
    @patch("haishui_cli.plugins_cmd._save_enabled_set")
    @patch("haishui_cli.plugins_cmd._get_disabled_set", return_value=set())
    @patch("haishui_cli.plugins_cmd._get_enabled_set", return_value=set())
...
class TestCompositeMenuWritesCanonicalKey:
    """#40190 follow-up: the interactive `haishui plugins` menu must persist
    ...
    def test_fallback_unchecked_plugin_disables_by_key_not_name(
        ...
        from haishui_cli.plugins_cmd import _run_composite_fallback
