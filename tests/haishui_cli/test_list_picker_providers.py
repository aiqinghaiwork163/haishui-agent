...
import haishui_cli.model_switch_providers as haishui_cli_model_switch_providers
...
def test_passthrough_kwargs_to_base(monkeypatch):
    ...
    monkeypatch.setattr(haishui_cli_model_switch_providers, "list_authenticated_providers", _capture)
    monkeypatch.setattr("haishui_cli.models.fetch_openrouter_models",
                        lambda *a, **kw: [])
...
def _stub_kimi_discovery(monkeypatch, *, canonical):
    ...
    import haishui_cli.models as hm
    import haishui_cli.models_catalog_static as haishui_cli_models_catalog_static
    from haishui_cli import models_catalog_static
    ...
    monkeypatch.setattr(haishui_cli_models_catalog_static, "CANONICAL_PROVIDERS", canonical)
