"""Fetch-failure classification for `haishui update` / `haishui update --check`.
...
CURL_429_STDERR = (
    "fatal: unable to access 'https://github.com/aiqinghaiwork163/haishui-agent.git/':"
...
def test_update_network_git_calls_never_prompt_for_credentials():
    ...
    Live incident (Sep 2026): a GitHub-side 401 made `haishui update` sit on
    ...
    from haishui_cli import update_cmd_git
