"""Regression test: haishui update must not load cryptography eagerly."""
...
assert 'haishui_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running haishui update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so haishui_cli is importable,
