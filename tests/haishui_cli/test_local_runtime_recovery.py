...
def test_startup_preserves_trees_and_explicit_stop_checks_owner(tmp_path, monkeypatch, case):
    from haishui_cli.local_runtime import bootstrap, supervisor
    ...
    monkeypatch.setattr("haishui_cli.local_runtime.binaries.installed_tags", lambda: [])
    ...
    try:
        ...
        from haishui_cli.local_runtime import endpoint
...
def test_startup_reuses_without_activity_probe(tmp_path, monkeypatch, failure):
    import http.client
    from haishui_cli.local_runtime import bootstrap, endpoint, recovery
...
def test_explicit_stop_preserves_verified_root_incarnation(tmp_path, monkeypatch, reuse_at):
    from unittest.mock import Mock
    from haishui_cli.local_runtime import recovery, supervisor
...
def test_reparented_router_keeps_its_endpoint(tmp_path, monkeypatch):
    from haishui_cli.local_runtime import endpoint, supervisor
...
def test_retained_endpoint_validates_identity(tmp_path, monkeypatch, damage):
    from haishui_cli.local_runtime import endpoint, recovery, supervisor
