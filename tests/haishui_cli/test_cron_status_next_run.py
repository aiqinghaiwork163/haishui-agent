...
from haishui_cli.cron import _print_active_jobs_summary
...
def _frozen_clock(monkeypatch):
    ...
    monkeypatch.setattr(job_store, "_haishui_now", lambda: now)
    monkeypatch.setattr("haishui_time.now", lambda: now)
