"""Regression: ``haishui doctor --fix`` must not checkpoint the live WAL under a running gateway.
...
# that depend on Haishui *choosing* WAL mode (declined on vulnerable SQLite
