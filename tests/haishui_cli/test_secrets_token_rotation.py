"""Tests for `haishui secrets bitwarden token` / `haishui secrets onepassword token`.
...
from haishui_cli import onepassword_secrets_cli as op_cli
from haishui_cli import secrets_cli as bw_cli
