...
class TestValidatorRules:
    ...
    def test_attacker_host_rejected(self, caplog):
        with caplog.at_level(logging.WARNING, logger="haishui_cli.auth"):
            assert (
...
class TestCallSiteWiring:
    ...
    def _read_auth_source(self):
        ...
        import haishui_cli.auth as _auth_mod
        import haishui_cli.auth_nous as _nous_mod
    ...
    def test_proxy_adapter_also_validates(self):
        ...
        boundary."""
        from pathlib import Path
        import haishui_cli.proxy.adapters.nous_portal as _nous_adapter
...
class TestHealsPoisonedStoredValue:
    ...
    def test_refresh_resets_rejected_url_to_default(self, monkeypatch):
        ...
        import haishui_cli.auth_nous as haishui_cli_auth_nous
        ...
        monkeypatch.setattr(haishui_cli_auth_nous, "_nous_invoke_jwt_status", lambda *a, **k: "needs_refresh")
        monkeypatch.setattr(
            auth,
        ...
        monkeypatch.setattr(haishui_cli_auth_nous, "_assert_nous_inference_jwt_usable", lambda *a, **k: None)
        monkeypatch.setattr(auth, "_select_nous_invoke_jwt", lambda *a, **k: None)
        monkeypatch.setattr(haishui_cli_auth_nous, "_select_nous_invoke_jwt", lambda *a, **k: None)
...
class TestEnvOverrideWins:
    ...
    def _patch_no_refresh(self, monkeypatch, auth, state):
        ...
        monkeypatch.setattr(haishui_cli_auth_nous, "_nous_invoke_jwt_status", lambda *a, **k: None)
        monkeypatch.setattr(
        ...
        monkeypatch.setattr(haishui_cli_auth_nous, "_write_shared_nous_state", lambda *a, **k: None)
        monkeypatch.setattr(auth, "_sync_nous_pool_from_auth_store", lambda *a, **k: None)
        monkeypatch.setattr(haishui_cli_auth_nous, "_sync_nous_pool_from_auth_store", lambda *a, **k: None)
