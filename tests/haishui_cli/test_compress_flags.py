...
Covers the pure helpers in ``haishui_cli.partial_compress`` plus alias
...
from haishui_cli.commands import COMMANDS, resolve_command
from haishui_cli.partial_compress import (
    DEFAULT_KEEP_LAST,
