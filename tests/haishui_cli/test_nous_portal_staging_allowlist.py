...
``HAISHUI_PORTAL_BASE_URL=https://portal.staging-nousresearch.com`` in its
...
class TestPortalEnvOverrideHelper:
    def test_none_when_unset(self, monkeypatch):
        monkeypatch.delenv("HAISHUI_PORTAL_BASE_URL", raising=False)
    ...
    def test_env_override_not_gated_by_allowlist(self, monkeypatch):
        ...
        monkeypatch.setenv(
            "HAISHUI_PORTAL_BASE_URL", "https://portal.staging-nousresearch.com"
        )
...
class TestResolveAccessTokenEnvOverrideWins:
    ...
    def test_env_override_wins_even_with_staging_state_stored(
        ...
        a prior HAISHUI_AUTH_JSON_BOOTSTRAP seed), and the env var is set to
        ...
        monkeypatch.setenv("HAISHUI_PORTAL_BASE_URL", staging_portal)
