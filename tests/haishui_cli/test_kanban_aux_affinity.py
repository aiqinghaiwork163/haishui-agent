...
from haishui_cli import kanban_decompose as decompose
from haishui_cli import kanban_specify as specify
...
def _dashboard_plugin_api():
    mod_name = "haishui_dashboard_plugin_kanban_aux_affinity_test"
