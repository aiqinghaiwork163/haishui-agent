...
Used by haishui_cli/skills_hub.py for CLI commands and the /skills slash command.
"""
...
_skills_dir = _path_resolver("SKILLS_DIR", "HAISHUI_HOME", "skills")
...
_DYNAMIC_PATH_RESOLVERS = {"HAISHUI_HOME": _haishui_home, **{
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'HAISHUI_INDEX_TTL': ('tools.skills_hub_search', 'HAISHUI_INDEX_TTL'),
    'HAISHUI_INDEX_URL': ('tools.skills_hub_search', 'HAISHUI_INDEX_URL'),
    'HaishuiIndexSource': ('tools.skills_hub_official', 'HaishuiIndexSource'),
