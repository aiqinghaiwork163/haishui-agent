...
`hey_haishui.onnx` / `hey_haishui.tflite` — the on-device "Hey Haishui" hotword
...
- **Label:** the model registers as `hey_haishui` (matches the filename).
