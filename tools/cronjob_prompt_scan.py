...
# containing `cat ~/.haishui/.env` or `rm -rf /`; there it is a smoking gun, not prose.
...
# `haishui-agent-dev` skill contains a security postmortem mentioning `cat ~/.haishui/.env`, which tripped
