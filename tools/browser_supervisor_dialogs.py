...
DIALOG_BRIDGE_HOST = "haishui-dialog-bridge.invalid"
...
(() => {
  if (window.__haishuiDialogBridgeInstalled) return;
  window.__haishuiDialogBridgeInstalled = true;
  const ENDPOINT = "http://haishui-dialog-bridge.invalid/";
