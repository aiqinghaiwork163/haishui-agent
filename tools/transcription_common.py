...
LOCAL_STT_COMMAND_ENV = "HAISHUI_LOCAL_STT_COMMAND"
LOCAL_STT_LANGUAGE_ENV = "HAISHUI_LOCAL_STT_LANGUAGE"
...
# DeepInfra STT base URL is resolved via haishui_cli.models.deepinfra_base_url (shared).
