"""Close a read-only agent terminal tab in the Haishui desktop GUI WITHOUT killing
...
CLOSE_TERMINAL_SCHEMA = {
    ...
    "description": (
        ...
        "the Haishui desktop GUI (the tabs mirroring terminal(background=true) runs). "
