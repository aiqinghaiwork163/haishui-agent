...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        _cmd("reset", "Reset your Haishui session"),
        ...
        _cmd("status", "Show Haishui session status"),
        _cmd("sethome", "Set this chat as the home channel"),
        _cmd("stop", "Stop the running Haishui agent"),
        ...
        _cmd("update", "Update Haishui Agent to the latest version"),
        _cmd("restart", "Gracefully restart the Haishui gateway"),
        ...
        _cmd("thread", "Create a new thread and start a Haishui session in it",
