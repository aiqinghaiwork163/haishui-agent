...
from gateway.platforms.yuanbao_proto import (
    CMD_TYPE, WS_HEARTBEAT_RUNNING, WS_HEARTBEAT_FINISH, HAISHUI_INSTANCE_ID,
...
_APP_VERSION = _BOT_VERSION = _HAISHUI_VERSION
_YUANBAO_INSTANCE_ID = str(HAISHUI_INSTANCE_ID)
...
class YuanbaoAdapter(BasePlatformAdapter):
    ...
    # Per Haishui home: a multiplexed gateway runs one Yuanbao adapter per profile, and the tools /
    ...
    def get_active(cls) -> Optional["YuanbaoAdapter"]:
        ...
        return cls._active_instances.get(haishui_home_key())
    ...
    def set_active(cls, adapter: Optional["YuanbaoAdapter"]) -> None:
        ...
        if get_haishui_home_override() is None:
            ...
            cls._active_instances.pop(haishui_home_key(), None)
        else:
            cls._active_instances[haishui_home_key()] = adapter
