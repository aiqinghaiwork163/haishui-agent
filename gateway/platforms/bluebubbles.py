...
# `require_mention: true` without custom aliases uses Haishui wake words.
DEFAULT_MENTION_PATTERNS = [r"(?<![\w@])@?haishui\s+agent\b[,:\-]?", r"(?<![\w@])@?haishui\b[,:\-]?"]
...
class BlueBubblesAdapter(BasePlatformAdapter):
    ...
    def _compile_mention_patterns(raw: Any) -> List[re.Pattern]:
        ...
        comma/newline-separated), or None (Haishui defaults)."""
