...
the same three things: what Haishui wants to run, why it was flagged, and that silence means
...
EA_HEADER_TEXT = "Haishui wants to run a command that needs your OK"
