 ...
 *
 * Each entry is a key/value pair that lands in the packaged Haishui.app's
 ...
 * "Haishui wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("Haishui wants to access Music" when Haishui never touches the Music
